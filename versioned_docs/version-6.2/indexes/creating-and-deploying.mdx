...
<a id="static-indexes"/>
<Admonition type="info" title="Define a static-index" id="define-a-static-index" href="#define-a-static-index">
...
<Admonition type="info" title="Deploy a static-index" id="deploy-a-static-index" href="#deploy-a-static-index">
...
<Admonition type="info" title="Create a static-index - Example" id="create-a-static-index-example" href="#create-a-static-index-example">
...
<Admonition type="info" title="Create a static-index - using an Operation" id="create-a-static-index-using-an-operation" href="#create-a-static-index-using-an-operation">
...
<a id="auto-indexes"/>
<Admonition type="info" title="Creating auto-indexes" id="creating-auto-indexes" href="#creating-auto-indexes">
...
<Admonition type="info" title="Disabling auto-indexes" id="disabling-auto-indexes" href="#disabling-auto-indexes">
...
<Admonition type="info" title="**Auto indexes**" id="auto-indexes" href="#auto-indexes">
...
<Admonition type="info" title="If indexes exhaust system resources" id="if-indexes-exhaust-system-resources" href="#if-indexes-exhaust-system-resources">
