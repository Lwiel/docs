...
<Admonition type="info" title="Why Rolling Index Deployment" id="why-rolling-index-deployment" href="#why-rolling-index-deployment">
...
<Admonition type="info" title="How Does It Work" id="how-does-it-work" href="#how-does-it-work">
...
<Admonition type="info" title="Setting Indexing Deployment Mode" id="setting-indexing-deployment-mode" href="#setting-indexing-deployment-mode">
