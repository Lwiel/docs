...
<Admonition type="info" title="Query an index by `Query`" id="query-an-index-by-query" href="#query-an-index-by-query">
...
<Admonition type="info" title="Query an index by `DocumentQuery`" id="query-an-index-by-documentquery" href="#query-an-index-by-documentquery">
...
<Admonition type="info" title="Query an index by `RawQuery`" id="query-an-index-by-rawquery" href="#query-an-index-by-rawquery">
...
<TabItem value="something-something" label="basics_0_2">
<CodeBlock language="java">
...
You can check the API reference for the `DocumentQuery` [here](../../client-api/session/querying/document-query/what-is-document-query).
</Admonition>
...
<Admonition type="info" title="Query an index by `query_index_type` and `query_index`" id="query-an-index-by-query_index_type-and-query_index" href="#query-an-index-by-query_index_type-and-query_index">
...
<Admonition type="info" title="Query an index by `raw_query`" id="query-an-index-by-raw_query" href="#query-an-index-by-raw_query">
...
<Admonition type="info" title="Query index - no filtering" id="query-index-no-filtering" href="#query-index-no-filtering">
...
<Admonition type="info" title="Query index - with filtering" id="query-index-with-filtering" href="#query-index-with-filtering">
...
<Admonition type="info" title="Query index - with paging" id="query-index-with-paging" href="#query-index-with-paging">
