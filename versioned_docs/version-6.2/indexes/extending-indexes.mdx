...
<Admonition type="info" title="Including additional sources from client code" id="including-additional-sources-from-client-code" href="#including-additional-sources-from-client-code">
