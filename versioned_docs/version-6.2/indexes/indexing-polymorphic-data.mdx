...
<Admonition type="info" title="Polymorphic Data" id="polymorphic-data" href="#polymorphic-data">
...
<TabItem value="something" label="other_ways_1">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="other_ways_1">
<CodeBlock language="java">
...
<Admonition type="info" title="Possible solutions" id="possible-solutions" href="#possible-solutions">
...
<TabItem value="something-something" label="define_convention">
<CodeBlock language="nodejs">
