...
<Admonition type="info" title="`CounterBatchOperation` default increment Delta is 1" id="counterbatchoperation-default-increment-delta-is-1" href="#counterbatchoperation-default-increment-delta-is-1">
...
<Admonition type="info" title="CmpXchg item can only be created with an index of 0" id="cmpxchg-item-can-only-be-created-with-an-index-of-0" href="#cmpxchg-item-can-only-be-created-with-an-index-of-0">
...
<Admonition type="info" title="Dynamic Linq query cannot apply `.Any` with logical AND (`&&`)" id="dynamic-linq-query-cannot-apply-any-with-logical-and" href="#dynamic-linq-query-cannot-apply-any-with-logical-and">
...
<Admonition type="info" title="`LoadDocument` must be provided with a collection name String" id="loaddocument-must-be-provided-with-a-collection-name-string" href="#loaddocument-must-be-provided-with-a-collection-name-string">
...
<Admonition type="info" title="Tracking operations using the Changes API now requires Node Tag" id="tracking-operations-using-the-changes-api-now-requires-node-tag" href="#tracking-operations-using-the-changes-api-now-requires-node-tag">
...
<Admonition type="info" title="Consistency in `null` handling" id="consistency-in-null-handling" href="#consistency-in-null-handling">
