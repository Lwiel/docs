...
<Admonition type="info" title="MSSQL connection string requires an Encrypt property" id="mssql-connection-string-requires-an-encrypt-property" href="#mssql-connection-string-requires-an-encrypt-property">
...
<Admonition type="info" title="Corax handling of complex JSON objects in static indexes is configurable" id="corax-handling-of-complex-json-objects-in-static-indexes-is-configurable" href="#corax-handling-of-complex-json-objects-in-static-indexes-is-configurable">
...
<Admonition type="info" title="Customizable identifier parts separator" id="customizable-identifier-parts-separator" href="#customizable-identifier-parts-separator">
