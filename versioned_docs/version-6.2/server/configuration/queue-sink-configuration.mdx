...
<Admonition type="info" title="`QueueSink.MaxBatchSize`" id="queuesink-maxbatchsize" href="#queuesink-maxbatchsize">
...
<Admonition type="info" title="`QueueSink.MaxFallbackTimeInSec`" id="queuesink-maxfallbacktimeinsec" href="#queuesink-maxfallbacktimeinsec">
