...
<Admonition type="info" title="Environment variables" id="environment-variables" href="#environment-variables">
...
<Admonition type="info" title="settings.json" id="settings-json" href="#settings-json">
...
<Admonition type="info" title="Command line arguments" id="command-line-arguments" href="#command-line-arguments">
...
<Admonition type="info" title="Database settings view" id="database-settings-view" href="#database-settings-view">
