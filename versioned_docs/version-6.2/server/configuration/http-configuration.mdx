...
<Admonition type="info" title="Http.MinDataRateBytesPerSec" id="http-mindataratebytespersec" href="#http-mindataratebytespersec">
...
<Admonition type="info" title="Http.MinDataRateGracePeriodInSec" id="http-mindatarategraceperiodinsec" href="#http-mindatarategraceperiodinsec">
...
<Admonition type="info" title="Http.MaxRequestBufferSizeInKb" id="http-maxrequestbuffersizeinkb" href="#http-maxrequestbuffersizeinkb">
...
<Admonition type="info" title="Http.MaxRequestLineSizeInKb" id="http-maxrequestlinesizeinkb" href="#http-maxrequestlinesizeinkb">
...
<Admonition type="info" title="Http.Http2.KeepAlivePingTimeoutInSec" id="http-http2-keepalivepingtimeoutinsec" href="#http-http2-keepalivepingtimeoutinsec">
...
<Admonition type="info" title="Http.Http2.KeepAlivePingDelayInSec" id="http-http2-keepalivepingdelayinsec" href="#http-http2-keepalivepingdelayinsec">
...
<Admonition type="info" title="Http.Http2.MaxStreamsPerConnection" id="http-http2-maxstreamsperconnection" href="#http-http2-maxstreamsperconnection">
...
<Admonition type="info" title="Http.UseResponseCompression" id="http-useresponsecompression" href="#http-useresponsecompression">
...
<Admonition type="info" title="Http.AllowResponseCompressionOverHttps" id="http-allowresponsecompressionoverhttps" href="#http-allowresponsecompressionoverhttps">
...
<Admonition type="info" title="Http.GzipResponseCompressionLevel" id="http-gzipresponsecompressionlevel" href="#http-gzipresponsecompressionlevel">
...
<Admonition type="info" title="Http.DeflateResponseCompressionLevel" id="http-deflateresponsecompressionlevel" href="#http-deflateresponsecompressionlevel">
...
<Admonition type="info" title="Http.ZstdResponseCompressionLevel" id="http-zstdresponsecompressionlevel" href="#http-zstdresponsecompressionlevel">
...
<Admonition type="info" title="Http.StaticFilesResponseCompressionLevel" id="http-staticfilesresponsecompressionlevel" href="#http-staticfilesresponsecompressionlevel">
...
<Admonition type="info" title="Http.Protocols" id="http-protocols" href="#http-protocols">
...
<Admonition type="info" title="Http.AllowSynchronousIO" id="http-allowsynchronousio" href="#http-allowsynchronousio">
