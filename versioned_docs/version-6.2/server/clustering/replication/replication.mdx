...
sidebar_position: 0
slug: /server/clustering/replication/replication
---
...
<Admonition type="info" title="Replication types" id="replication-types" href="#replication-types">
...
<Admonition type="info" title="What is replicated" id="what-is-replicated" href="#what-is-replicated">
...
<Admonition type="info" title="How replication works" id="how-replication-works" href="#how-replication-works">
...
<Admonition type="info" title="Replication & transaction boundary" id="replication-transaction-boundary" href="#replication-transaction-boundary">
