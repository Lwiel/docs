...
<Admonition type="info" title="Examples in this page " id="examples-in-this-page" href="#examples-in-this-page">
...
<TabItem value="something" label="Embedded_OpenStudio">
...
<TabItem value="something" label="Embedded_Replication_Setup">
<CodeBlock language="csharp">
...
<TabItem value="something" label="External_Replication_And_Embedded">
<CodeBlock language="csharp">
{`//first, initialize connection with one of cluster nodes
var ravenClusterNodeUrl = "http://localhost:8080";
using (var store = new DocumentStore
