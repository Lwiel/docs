...
<Admonition type="info" title="Operation flow" id="operation-flow" href="#operation-flow">
...
<Admonition type="info" title="Interacting with the Cluster Observer" id="interacting-with-the-cluster-observer" href="#interacting-with-the-cluster-observer">
