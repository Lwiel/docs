...
<Admonition type="info" title="Operations that require Consensus" id="operations-that-require-consensus" href="#operations-that-require-consensus">
...
<Admonition type="info" title="Operations that do not require Consensus" id="operations-that-do-not-require-consensus" href="#operations-that-do-not-require-consensus">
...
<Admonition type="info" title="Raft Commands Implementation Details" id="raft-commands-implementation-details" href="#raft-commands-implementation-details">
