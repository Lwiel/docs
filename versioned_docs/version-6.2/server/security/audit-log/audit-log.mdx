...
sidebar_position: 0
slug: /server/security/audit-log/audit-log
---
...
<Admonition type="info" title="Enabling the audit log" id="enabling-the-audit-log" href="#enabling-the-audit-log">
...
<Admonition type="info" title="What is being logged" id="what-is-being-logged" href="#what-is-being-logged">
...
<Admonition type="info" title="Things to consider" id="things-to-consider" href="#things-to-consider">
