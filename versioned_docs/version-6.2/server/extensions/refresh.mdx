...
<Admonition type="info" title="Configure from Studio" id="configure-from-studio" href="#configure-from-studio">
...
<TabItem value="something-something" label="configure_refresh">
...
<TabItem value="something-something" label="refresh_example">
<CodeBlock language="nodejs">
