...
<Admonition type="info" title="Elasticsearch ETL" id="elasticsearch-etl" href="#elasticsearch-etl">
...
<Admonition type="info" title="Transformation Script" id="transformation-script" href="#transformation-script">
...
<Admonition type="info" title="Data Delivery" id="data-delivery" href="#data-delivery">
...
<Admonition type="info" title="Elasticsearch Index Definition" id="elasticsearch-index-definition" href="#elasticsearch-index-definition">
...
<Admonition type="info" title="Client API" id="client-api" href="#client-api">
...
**Code Sample**:  
<TabItem value="something" label="create-connection-string">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Supported Elasticsearch Versions" id="supported-elasticsearch-versions" href="#supported-elasticsearch-versions">
