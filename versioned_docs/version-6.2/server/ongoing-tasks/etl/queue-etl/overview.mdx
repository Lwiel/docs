...
<Admonition type="info" title="Queue ETL tasks" id="queue-etl-tasks" href="#queue-etl-tasks">
...
<Admonition type="info" title="CloudEvents" id="cloudevents" href="#cloudevents">
...
<Admonition type="info" title="Task statistics" id="task-statistics" href="#task-statistics">
