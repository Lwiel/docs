...
<Admonition type="info" title="On-disk Data Structure" id="on-disk-data-structure" href="#on-disk-data-structure">
...
<Admonition type="info" title="Voron Storage Environment" id="voron-storage-environment" href="#voron-storage-environment">
