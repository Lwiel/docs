...
<Admonition type="info" title="Activate license with configuration keys" id="activate-license-with-configuration-keys" href="#activate-license-with-configuration-keys">
...
<Admonition type="info" title="Activate license from Studio" id="activate-license-from-studio" href="#activate-license-from-studio">
