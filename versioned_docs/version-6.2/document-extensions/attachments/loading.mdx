...
<Admonition type="info" title="Load attachments" id="load-attachments" href="#load-attachments">
...
<Admonition type="info" title="Load a part of an attachment" id="load-a-part-of-an-attachment" href="#load-a-part-of-an-attachment">
