...
<Admonition type="info" title="Document Extensions" id="document-extensions" href="#document-extensions">
...
<Admonition type="info" title="Studio Document Extension Views" id="studio-document-extension-views" href="#studio-document-extension-views">
