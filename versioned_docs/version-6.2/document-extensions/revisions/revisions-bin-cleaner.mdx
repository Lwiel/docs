...
<Admonition type="info" title="The revisions bin cleaner" id="the-revisions-bin-cleaner" href="#the-revisions-bin-cleaner">
...
<Admonition type="info" title="Setting the revisions bin cleaner - from the Studio" id="setting-the-revisions-bin-cleaner-from-the-studio" href="#setting-the-revisions-bin-cleaner-from-the-studio">
...
<Admonition type="info" title="Setting the revisions bin cleaner - from the Client API" id="setting-the-revisions-bin-cleaner-from-the-client-api" href="#setting-the-revisions-bin-cleaner-from-the-client-api">
