...
<Admonition type="info" title="Configure revisions for conflicts - Example" id="configure-revisions-for-conflicts-example" href="#configure-revisions-for-conflicts-example">
