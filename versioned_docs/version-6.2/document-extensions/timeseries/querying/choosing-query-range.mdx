...
<Admonition type="info" title="Choose range in a query" id="choose-range-in-a-query" href="#choose-range-in-a-query">
...
<Admonition type="info" title="Choose range - RQL syntax" id="choose-range-rql-syntax" href="#choose-range-rql-syntax">
