...
<Admonition type="info" title="`IncrementalTimeSeriesFor.Delete`" id="incrementaltimeseriesfor-delete" href="#incrementaltimeseriesfor-delete">
...
<TabItem value="something" label="incremental_delete-values-range-or-all-values">
...
<TabItem value="something" label="incremental_delete-value-at-timestamp">
<CodeBlock language="csharp">
...
<TabItem value="something" label="incremental_delete-single-entry">
<CodeBlock language="csharp">
{`// Delete a single entry
...
<TabItem value="something" label="incremental_delete-entries-range">
<CodeBlock language="csharp">
