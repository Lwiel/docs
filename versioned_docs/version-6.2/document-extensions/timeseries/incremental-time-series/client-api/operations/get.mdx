...
<Admonition type="info" title="`GetTimeSeriesOperation`" id="gettimeseriesoperation" href="#gettimeseriesoperation">
...
<TabItem value="something" label="incremental_declaration_GetTimeSeriesOperation">
...
<TabItem value="something" label="incremental_GetTimeSeriesOperation">
<CodeBlock language="csharp">
{`int pageSize = 100;
...
<Admonition type="info" title="`GetMultipleTimeSeriesOperation`" id="getmultipletimeseriesoperation" href="#getmultipletimeseriesoperation">
