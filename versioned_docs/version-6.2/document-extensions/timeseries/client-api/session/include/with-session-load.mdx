...
<Admonition type="info" title="Include time series when loading a document" id="include-time-series-when-loading-a-document" href="#include-time-series-when-loading-a-document">
