...
<Admonition type="info" title="Time series policies" id="time-series-policies" href="#time-series-policies">
...
<TabItem value="something" label="rollup_and_retention_0">
...
<TabItem value="something" label="rollup_and_retention_1">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="rollup_and_retention_0">
...
<TabItem value="something-something" label="rollup_and_retention_1">
<CodeBlock language="python">
...
<TabItem value="something-something" label="rollup_1">
...
<TabItem value="something-something" label="rollup_2">
<CodeBlock language="nodejs">
{`// Get all data from the RAW time series:
// ======================================
