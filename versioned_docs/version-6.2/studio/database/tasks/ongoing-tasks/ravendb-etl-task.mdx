...
<Admonition type="info" title="RavenDB ETL Task - Definition" id="ravendb-etl-task-definition" href="#ravendb-etl-task-definition">
...
<Admonition type="info" title="RavenDB ETL Task - Transform Scripts" id="ravendb-etl-task-transform-scripts" href="#ravendb-etl-task-transform-scripts">
...
<Admonition type="info" title="Passing Certificate Between Secure Clusters" id="passing-certificate-between-secure-clusters" href="#passing-certificate-between-secure-clusters">
...
<Admonition type="info" title="RavenDB ETL Task - Details in Tasks List View" id="ravendb-etl-task-details-in-tasks-list-view" href="#ravendb-etl-task-details-in-tasks-list-view">
...
<Admonition type="info" title="RavenDB ETL Task - Offline Behaviour" id="ravendb-etl-task-offline-behaviour" href="#ravendb-etl-task-offline-behaviour">
...
<Admonition type="info" title="RavenDB ETL Task -vs- External Replication Task" id="ravendb-etl-task-vs-external-replication-task" href="#ravendb-etl-task-vs-external-replication-task">
