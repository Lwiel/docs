...
<Admonition type="info" title="Open Kafka ETL Task View" id="open-kafka-etl-task-view" href="#open-kafka-etl-task-view">
...
<Admonition type="info" title="Define Kafka ETL Task" id="define-kafka-etl-task" href="#define-kafka-etl-task">
...
<Admonition type="info" title="Use RavenDB Certificate" id="use-ravendb-certificate" href="#use-ravendb-certificate">
...
<Admonition type="info" title="Options Per Topic" id="options-per-topic" href="#options-per-topic">
...
<Admonition type="info" title="Edit Transformation Script" id="edit-transformation-script" href="#edit-transformation-script">
