...
<Admonition type="info" title="Export Database View" id="export-database-view" href="#export-database-view">
...
<Admonition type="info" title="Advanced Export Options" id="advanced-export-options" href="#advanced-export-options">
