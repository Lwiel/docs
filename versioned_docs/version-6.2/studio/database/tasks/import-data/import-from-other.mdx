...
<Admonition type="info" title="Download Raven.Migrator Tool" id="download-raven-migrator-tool" href="#download-raven-migrator-tool">
...
<Admonition type="info" title="Import from MongoDB" id="import-from-mongodb" href="#import-from-mongodb">
...
<Admonition type="info" title="Import from CosmosDB" id="import-from-cosmosdb" href="#import-from-cosmosdb">
In the RavenDB Studio client on the left side, select `Tasks` -&gt; `Import Data`.
