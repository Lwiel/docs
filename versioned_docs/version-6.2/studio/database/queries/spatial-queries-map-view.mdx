...
<Admonition type="info" title="Spatial data in documents" id="spatial-data-in-documents" href="#spatial-data-in-documents">
...
<Admonition type="info" title="Running a dynamic spatial query" id="running-a-dynamic-spatial-query" href="#running-a-dynamic-spatial-query">
...
<Admonition type="info" title="Spatial map view" id="spatial-map-view" href="#spatial-map-view">
