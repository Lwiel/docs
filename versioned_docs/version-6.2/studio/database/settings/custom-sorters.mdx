...
<Admonition type="info" title="Database custom sorter view" id="database-custom-sorter-view" href="#database-custom-sorter-view">
...
<Admonition type="info" title="Server-wide custom sorter view" id="server-wide-custom-sorter-view" href="#server-wide-custom-sorter-view">
...
<Admonition type="info" title="Add a custom sorter" id="add-a-custom-sorter" href="#add-a-custom-sorter">
...
<Admonition type="info" title="Test the custom sorter" id="test-the-custom-sorter" href="#test-the-custom-sorter">
