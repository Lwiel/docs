...
<Admonition type="info" title="Scheduling a Server-Wide Backup Task" id="scheduling-a-server-wide-backup-task" href="#scheduling-a-server-wide-backup-task">
...
<Admonition type="info" title="Restoring a Database From a Server-Wide Backup" id="restoring-a-database-from-a-server-wide-backup" href="#restoring-a-database-from-a-server-wide-backup">
...
<Admonition type="info" title="Server-Wide Backup Tasks in the Database Tasks View" id="server-wide-backup-tasks-in-the-database-tasks-view" href="#server-wide-backup-tasks-in-the-database-tasks-view">
...
<Admonition type="info" title="The Responsible Node" id="the-responsible-node" href="#the-responsible-node">
