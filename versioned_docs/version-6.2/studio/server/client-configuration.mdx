...
<Admonition type="info" title="Set the client-configuration (server-wide)" id="set-the-client-configuration-server-wide" href="#set-the-client-configuration-server-wide">
