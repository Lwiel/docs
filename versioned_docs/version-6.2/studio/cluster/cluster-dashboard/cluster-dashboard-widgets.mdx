...
<Admonition type="info" title="Let's Get Started Widget" id="let-s-get-started-widget" href="#let-s-get-started-widget">
...
<Admonition type="info" title="CPU Widget" id="cpu-widget" href="#cpu-widget">
...
<Admonition type="info" title="Memory Widget" id="memory-widget" href="#memory-widget">
...
<Admonition type="info" title="Traffic Widget" id="traffic-widget" href="#traffic-widget">
...
<Admonition type="info" title="Traffic Per Database Widget" id="traffic-per-database-widget" href="#traffic-per-database-widget">
...
<Admonition type="info" title="Indexing Widget" id="indexing-widget" href="#indexing-widget">
...
<Admonition type="info" title="Indexing Per Database Widget" id="indexing-per-database-widget" href="#indexing-per-database-widget">
...
<Admonition type="info" title="Storage Widget" id="storage-widget" href="#storage-widget">
...
<Admonition type="info" title="Storage Per Database Widget" id="storage-per-database-widget" href="#storage-per-database-widget">
...
<Admonition type="info" title="License Widget" id="license-widget" href="#license-widget">
