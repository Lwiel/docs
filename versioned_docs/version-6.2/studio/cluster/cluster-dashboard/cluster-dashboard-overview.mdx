...
<Admonition type="info" title="Cluster Dashboard Initial Display" id="cluster-dashboard-initial-display" href="#cluster-dashboard-initial-display">
...
<Admonition type="info" title="Cluster Dashboard Widgets Display" id="cluster-dashboard-widgets-display" href="#cluster-dashboard-widgets-display">
...
<Admonition type="info" title="Setup changes" id="setup-changes" href="#setup-changes">
