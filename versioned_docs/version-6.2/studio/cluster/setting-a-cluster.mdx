...
<Admonition type="info" title="Add Another Node to the Cluster" id="add-another-node-to-the-cluster" href="#add-another-node-to-the-cluster">
...
<Admonition type="info" title="A Cluster with 2 nodes" id="a-cluster-with-2-nodes" href="#a-cluster-with-2-nodes">
