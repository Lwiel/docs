...
<Admonition type="info" title="Waiting for Indexes" id="waiting-for-indexes" href="#waiting-for-indexes">
...
<Admonition type="info" title="Waiting for Replication - Write Assurance" id="waiting-for-replication-write-assurance" href="#waiting-for-replication-write-assurance">
...
<Admonition type="info" title="Transaction Mode - Cluster Wide" id="transaction-mode-cluster-wide" href="#transaction-mode-cluster-wide">
...
<TabItem value="something-something" label="saving_changes_1">
...
<TabItem value="something-something" label="saving_changes_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="saving_changes_3">
<CodeBlock language="java">
...
<TabItem value="something-something" label="saving_changes_4">
<CodeBlock language="java">
{`session
    .advanced()
...
<TabItem value="something-something" label="cluster_store_with_compare_exchange">
<CodeBlock language="java">
