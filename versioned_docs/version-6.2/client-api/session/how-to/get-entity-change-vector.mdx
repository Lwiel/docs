...
<TabItem value="something" label="get_change_vector_1">
...
<TabItem value="something" label="get_change_vector_2">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="get_change_vector_1">
...
<TabItem value="something-something" label="get_change_vector_2">
<CodeBlock language="java">
