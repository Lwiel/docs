...
<Admonition type="info" title="Session overview" id="session-overview" href="#session-overview">
...
<Admonition type="info" title="Unit of work pattern" id="unit-of-work-pattern" href="#unit-of-work-pattern">  
...
<Admonition type="info" title="Identity map pattern" id="identity-map-pattern" href="#identity-map-pattern">  
...
<Admonition type="info" title="Batching & Transactions" id="batching-transactions" href="#batching-transactions">
...
<Admonition type="info" title="Concurrency control" id="concurrency-control" href="#concurrency-control">
...
<Admonition type="info" title="Reducing server calls (best practices) for:" id="reducing-server-calls-best-practices-for" href="#reducing-server-calls-best-practices-for">
...
<TabItem value="something-something" label="session_usage_1">
...
<TabItem value="something-something" label="session_usage_2">
<CodeBlock language="java">
{`// Open a session
try (IDocumentSession session = store.openSession()) \{
    // Load an existing document to the Session using its ID
...
<TabItem value="something-something" label="session_usage_3">
<CodeBlock language="java">
{`// A document is fetched from the server
