...
<Admonition type="info" title="Session options" id="session-options" href="#session-options">
...
<Admonition type="info" title="Open session example" id="open-session-example" href="#open-session-example">
...
<TabItem value="something-something" label="open_session_1">
...
<TabItem value="something-something" label="open_session_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="open_session_3">
<CodeBlock language="java">
...
<TabItem value="something-something" label="session_options">
<CodeBlock language="java">
...
<TabItem value="something-something" label="open_session_4">
<CodeBlock language="java">
...
<TabItem value="something-something" label="open_session_tracking_1">
<CodeBlock language="java">
{`SessionOptions sessionOptions = new SessionOptions();
...
<Admonition type="info" title="Open session examples" id="open-session-examples" href="#open-session-examples">
...
<TabItem value="something-something" label="open_session_no_tracking">
<CodeBlock language="php">
{`$sessionOptions = new SessionOptions();
$sessionOptions->setNoTracking(true);
$session = $store->openSession();
...
<TabItem value="something-something" label="open_session_no_caching">
<CodeBlock language="php">
{`$sessionOptions = new SessionOptions();
