...
<Admonition type="info" title="The query pipeline" id="the-query-pipeline" href="#the-query-pipeline">  
...
<Admonition type="info" title="RQL keywords and methods" id="rql-keywords-and-methods" href="#rql-keywords-and-methods">
...
<Admonition type="info" title="`declare`" id="declare" href="#declare">
...
<Admonition type="info" title="`from`" id="from" href="#from">
...
<Admonition type="info" title="`group by`" id="group-by" href="#group-by">
...
<Admonition type="info" title="`include`" id="include" href="#include">
...
<Admonition type="info" title="`order by`" id="order-by" href="#order-by">
...
<Admonition type="info" title="`limit`" id="limit" href="#limit">
...
<Admonition type="info" title="`update`" id="update" href="#update">
...
<Admonition type="info" title="RQL comments" id="rql-comments" href="#rql-comments">
