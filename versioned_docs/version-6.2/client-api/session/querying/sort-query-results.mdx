...
<Admonition type="info" title="Order by field value" id="order-by-field-value" href="#order-by-field-value">
...
<Admonition type="info" title="Order by score" id="order-by-score" href="#order-by-score">
...
<Admonition type="info" title="Order by random" id="order-by-random" href="#order-by-random">
...
<Admonition type="info" title="Order by spatial" id="order-by-spatial" href="#order-by-spatial">
...
<Admonition type="info" title="Order by count (aggregation query)" id="order-by-count-aggregation-query" href="#order-by-count-aggregation-query">
...
<Admonition type="info" title="Order by sum (aggregation query)" id="order-by-sum-aggregation-query" href="#order-by-sum-aggregation-query">
...
<Admonition type="info" title="Force ordering type" id="force-ordering-type" href="#force-ordering-type">
...
<Admonition type="info" title="Chain ordering" id="chain-ordering" href="#chain-ordering">
...
<Admonition type="info" title="Custom sorters " id="custom-sorters" href="#custom-sorters">
