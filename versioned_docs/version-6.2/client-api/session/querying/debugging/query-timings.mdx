...
<Admonition type="info" title="Include timings in a query" id="include-timings-in-a-query" href="#include-timings-in-a-query">
...
<Admonition type="info" title="View timings" id="view-timings" href="#view-timings">
...
<Admonition type="info" title="Timings in a sharded database" id="timings-in-a-sharded-database" href="#timings-in-a-sharded-database">
...
<TabItem value="something-something" label="timing_1">
<CodeBlock language="java">
