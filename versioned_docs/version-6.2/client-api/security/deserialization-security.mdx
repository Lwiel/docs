...
<Admonition type="info" title="Securing Deserialization" id="securing-deserialization" href="#securing-deserialization">
...
<Admonition type="info" title="Invoking a Gadget" id="invoking-a-gadget" href="#invoking-a-gadget">
...
<TabItem value="something" label="DeserializationSecurity_load-object">
...
<TabItem value="something" label="DeserializationSecurity_define-type">
<CodeBlock language="csharp">
{`string userdata = @"\{
...
<Admonition type="info" title="`DefaultRavenSerializationBinder`" id="defaultravenserializationbinder" href="#defaultravenserializationbinder">
...
<TabItem value="something" label="RegisterForbiddenNamespace_definition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="RegisterForbiddenType_definition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="RegisterSafeType_definition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="DefaultRavenSerializationBinder">
<CodeBlock language="csharp">
