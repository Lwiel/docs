...
<Admonition type="info" title="Client/Server Compatibility" id="client-server-compatibility" href="#client-server-compatibility">
...
<Admonition type="info" title="Upgrading" id="upgrading" href="#upgrading">
