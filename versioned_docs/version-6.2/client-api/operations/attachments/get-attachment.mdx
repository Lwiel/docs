...
<TabItem value="something-something" label="get_attachment_syntax">
...
<TabItem value="something-something" label="get_attachment_return_value">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Get attachment example" id="get-attachment-example" href="#get-attachment-example">

<TabItem value="something-something" label="get_attachment">
