...
<TabItem value="something" label="cert_1_1">
...
<TabItem value="something" label="cert_1_4">
<CodeBlock language="csharp">
...
<TabItem value="something" label="cert_1_5">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="cert_1_1">
...
<TabItem value="something-something" label="cert_1_4">
<CodeBlock language="java">
...
<TabItem value="something-something" label="cert_1_5">
<CodeBlock language="java">
