...
<Admonition type="info" title="Syntax overview" id="syntax-overview" href="#syntax-overview">
...
<Admonition type="info" title="Additional notes" id="additional-notes" href="#additional-notes">
