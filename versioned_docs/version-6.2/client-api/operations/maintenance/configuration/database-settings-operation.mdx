...
<Admonition type="info" title="Put database settings operation" id="put-database-settings-operation" href="#put-database-settings-operation">
...
<Admonition type="info" title="Get database settings operation" id="get-database-settings-operation" href="#get-database-settings-operation">
