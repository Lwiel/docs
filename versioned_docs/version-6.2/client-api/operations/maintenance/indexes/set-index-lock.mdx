...
<Admonition type="info" title="Lock modes" id="lock-modes" href="#lock-modes">
...
<Admonition type="info" title="Sample usage flow" id="sample-usage-flow" href="#sample-usage-flow">
...
<Admonition type="info" title="Set lock mode - single index" id="set-lock-mode-single-index" href="#set-lock-mode-single-index">
...
<Admonition type="info" title="Set lock mode - multiple indexes" id="set-lock-mode-multiple-indexes" href="#set-lock-mode-multiple-indexes">
