...
<Admonition type="info" title="How to enable an index" id="how-to-enable-an-index" href="#how-to-enable-an-index">
...
<Admonition type="info" title="Enable index from the Client API" id="enable-index-from-the-client-api" href="#enable-index-from-the-client-api">
...
<TabItem value="something-something" label="enable_1">
...
<TabItem value="something-something" label="enable_2">
<CodeBlock language="java">
