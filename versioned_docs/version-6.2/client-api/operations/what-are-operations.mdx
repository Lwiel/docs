...
<Admonition type="info" title="Why use operations" id="why-use-operations" href="#why-use-operations">
...
<Admonition type="info" title="How operations work" id="how-operations-work" href="#how-operations-work">
...
<Admonition type="info" title="Common operations" id="common-operations" href="#common-operations">
...
<Admonition type="info" title="Maintenance operations" id="maintenance-operations" href="#maintenance-operations">
...
<Admonition type="info" title="Server-maintenance operations" id="server-maintenance-operations" href="#server-maintenance-operations">
...
<Admonition type="info" title="Manage lengthy operations" id="manage-lengthy-operations" href="#manage-lengthy-operations">
...
<TabItem value="something" label="kill_syntax">
<CodeBlock language="csharp">
{`// Available overloads:
public void Kill()
...
<TabItem value="something-something" label="Client_Operations_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="Maintenance_Operations_api">
<CodeBlock language="java">
...
<TabItem value="something-something" label="Maintenance_Operations_1">
<CodeBlock language="java">
...
<Admonition type="info" title="Server Operations" id="server-operations" href="#server-operations">
...
<TabItem value="something-something" label="Server_Operations_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="operations_ex">
...
<TabItem value="something-something" label="operations_send">
<CodeBlock language="python">
{`# Available overloads:
...
<TabItem value="something-something" label="maintenance_ex">
<CodeBlock language="python">
{`# Define operation, e.g. stop an index
...
<TabItem value="something-something" label="maintenance_send">
<CodeBlock language="python">
{`def send(
...
<TabItem value="something-something" label="server_ex">
<CodeBlock language="python">
{`# Define operation, e.g. get the server build number
...
<TabItem value="something-something" label="server_send">
<CodeBlock language="python">
...
<TabItem value="something-something" label="wait_timeout_ex">
<CodeBlock language="php">
...
<TabItem value="something-something" label="waitForCompletion_syntax">
<CodeBlock language="php">
{`/**
...
<TabItem value="something-something" label="wait_ex">
<CodeBlock language="nodejs">
{`// Define operation, e.g. delete all discontinued products 
// Note: This operation implements interface: 'IOperation<OperationIdResult>'
...
<TabItem value="something-something" label="kill_ex">
<CodeBlock language="nodejs">
{`// Define operation, e.g. delete all discontinued products 
// Note: This operation implements interface: 'IOperation<OperationIdResult>'
const deleteByQueryOp = new DeleteByQueryOperation("from Products where Discontinued = true");
...
<TabItem value="something-something" label="wait_kill_syntax">
<CodeBlock language="nodejs">
