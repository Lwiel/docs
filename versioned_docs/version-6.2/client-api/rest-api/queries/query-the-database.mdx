...
| **explain** | Used for queries on [Auto Indexes](../../../indexes/creating-and-deploying#auto-indexes).
...
If no index was found, this query will _not_ trigger the creation of an auto index as it normally would. |
