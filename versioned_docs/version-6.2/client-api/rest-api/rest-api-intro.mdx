...
<Admonition type="info" title="cURL Basics" id="curl-basics" href="#curl-basics">
...
<Admonition type="info" title="Document Format and Structure" id="document-format-and-structure" href="#document-format-and-structure">
...
<Admonition type="info" title="Using cURL With HTTPS" id="using-curl-with-https" href="#using-curl-with-https">
...
<Admonition type="info" title="Common HTTP Status Codes" id="common-http-status-codes" href="#common-http-status-codes">
