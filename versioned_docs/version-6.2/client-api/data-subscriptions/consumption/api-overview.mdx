...
<Admonition type="info" title="Create the subscription worker" id="create-the-subscription-worker" href="#create-the-subscription-worker">
...
<Admonition type="info" title="SubscriptionWorkerOptions" id="subscriptionworkeroptions" href="#subscriptionworkeroptions">
...
<Admonition type="info" title="Run the subscription worker" id="run-the-subscription-worker" href="#run-the-subscription-worker">
...
<Admonition type="info" title="SubscriptionBatch&lt;T&gt;" id="subscriptionbatch-lt-t-gt" href="#subscriptionbatch-lt-t-gt">
...
<Admonition type="info" title="SubscriptionWorker&lt;T&gt;" id="subscriptionworker-lt-t-gt" href="#subscriptionworker-lt-t-gt">
...
<Admonition type="info" title="`SubscriptionBatch[_T]`" id="subscriptionbatch-_t" href="#subscriptionbatch-_t">
...
<Admonition type="info" title="`SubscriptionWorker[_T]`" id="subscriptionworker-_t" href="#subscriptionworker-_t">
...
<Admonition type="info" title="Subscription worker options" id="subscription-worker-options" href="#subscription-worker-options">
...
<Admonition type="info" title="Subscription batch" id="subscription-batch" href="#subscription-batch">
...
<Admonition type="info" title="Subscription batch item" id="subscription-batch-item" href="#subscription-batch-item">
...
<Admonition type="info" title="Subscription worker" id="subscription-worker" href="#subscription-worker">
