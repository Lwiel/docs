...
<Admonition type="info" title="Data subscription consumption" id="data-subscription-consumption" href="#data-subscription-consumption">
...
<Admonition type="info" title="What defines a data subscription" id="what-defines-a-data-subscription" href="#what-defines-a-data-subscription">
...
<Admonition type="info" title="Documents processing" id="documents-processing" href="#documents-processing">
...
<Admonition type="info" title="Progress Persistence" id="progress-persistence" href="#progress-persistence">
...
<Admonition type="info" title="How the worker communicates with the server" id="how-the-worker-communicates-with-the-server" href="#how-the-worker-communicates-with-the-server">
...
<Admonition type="info" title="Working with multiple clients" id="working-with-multiple-clients" href="#working-with-multiple-clients">
...
<Admonition type="info" title="Data subscriptions usage example" id="data-subscriptions-usage-example" href="#data-subscriptions-usage-example">

Data subscriptions are accessible by a document store.  
Here's an example of creating and using a data subscription:

<TabItem value="something" label="subscriptions_example">
...
<TabItem value="something-something" label="subscriptions_example">
