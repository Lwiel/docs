...
<Admonition type="info" title="Create subscription - for all documents in a collection" id="create-subscription-for-all-documents-in-a-collection" href="#create-subscription-for-all-documents-in-a-collection">
...
<Admonition type="info" title="Create subscription - filter documents" id="create-subscription-filter-documents" href="#create-subscription-filter-documents">
...
<Admonition type="info" title="Create subscription - filter and project fields" id="create-subscription-filter-and-project-fields" href="#create-subscription-filter-and-project-fields">
...
<Admonition type="info" title="Create subscription - project data from a related document" id="create-subscription-project-data-from-a-related-document" href="#create-subscription-project-data-from-a-related-document"> 
...
<Admonition type="info" title="Create subscription - include documents" id="create-subscription-include-documents" href="#create-subscription-include-documents">
...
<Admonition type="info" title="Create subscription - include counters" id="create-subscription-include-counters" href="#create-subscription-include-counters">
...
<TabItem value="something-something" label="include_builder_counter_methods">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="create_subscription_include_chained_builder">
<CodeBlock language="csharp">
{`subscriptionName = store.Subscriptions.Create<Order>(new SubscriptionCreationOptions<Order>()
\{
    Includes = builder => builder
...
<Admonition type="info" title="Create subscription - subscribe to revisions" id="create-subscription-subscribe-to-revisions" href="#create-subscription-subscribe-to-revisions">
...
<Admonition type="info" title="Create subscription - via update" id="create-subscription-via-update" href="#create-subscription-via-update">
...
<TabItem value="something-something" label="create_by_update">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Update existing subscription" id="update-existing-subscription" href="#update-existing-subscription">
...
<TabItem value="something-something" label="update_subscription_example_0">
<CodeBlock language="csharp">
{`subscriptionName = store.Subscriptions.Update(new SubscriptionUpdateOptions()
\{
...
<TabItem value="something-something" label="update_subscription_example_1">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="update_subscription_example_2">
<CodeBlock language="csharp">
{`// Get the subscription's ID
...
<TabItem value="something-something" label="create_filter_only_RQL">
<CodeBlock language="python">
...
<TabItem value="something-something" label="create_filter_and_projection_RQL">
<CodeBlock language="python">
{`name = store.subscriptions.create_for_options(
    SubscriptionCreationOptions(
        query="""
...
<TabItem value="something-something" label="create_filter_and_load_document_RQL">
<CodeBlock language="python">
{`name = store.subscriptions.create_for_options(
    SubscriptionCreationOptions(
        query="""
...
<TabItem value="something-something" label="create_subscription_include_counters_builder">
<CodeBlock language="python">
{`store.subscriptions.create_for_class(
    Order,
    SubscriptionCreationOptions(
...
<TabItem value="something-something" label="create_1">
...
<TabItem value="something-something" label="create_1_1">
<CodeBlock language="nodejs">
{`const subscriptionName = await documentStore.subscriptions.create(\{
    name: "OrdersProcessingSubscription",
...
<TabItem value="something-something" label="create_1_2">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="create_2">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="create_3">
<CodeBlock language="nodejs">
{`const query = \`
    declare function getOrderLinesSum(doc) \{
        var sum = 0; 
...
<TabItem value="something-something" label="create_4">
<CodeBlock language="nodejs">
{`const query = \`
    declare function getOrderLinesSum(doc) \{
        var sum = 0;
...
<TabItem value="something-something" label="create_8">
<CodeBlock language="nodejs">
{`const options = \{
    includes: builder => builder
        .includeCounter("Likes")
...
<TabItem value="something-something" label="update_0">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="update_1">
<CodeBlock language="nodejs">
{`const subscriptionName = await documentStore.subscriptions.update(\{
    // Specify the subscription you wish to modify
    name: "my subscription",
...
<TabItem value="something-something" label="update_2">
<CodeBlock language="nodejs">
{`// Get the subscription's ID
...
<TabItem value="something-something" label="update_3">
<CodeBlock language="nodejs">
{`// Get the subscription's ID
const mySubscription = await documentStore.subscriptions.getSubscriptionState("my subscription");
const subscriptionId = mySubscription.subscriptionId;
