...
<Admonition type="info" title="Available batch commands" id="available-batch-commands" href="#available-batch-commands">
...
<TabItem value="something-something" label="batch_1">
...
<TabItem value="something-something" label="batch_2">
<CodeBlock language="java">
{`public class BatchOptions \{
...
<TabItem value="something-something" label="batch_3">
<CodeBlock language="java">
