...
<Admonition type="info" title="A Free Cloud Node" id="a-free-cloud-node" href="#a-free-cloud-node">
...
<Admonition type="info" title="A Development Cloud Server" id="a-development-cloud-server" href="#a-development-cloud-server">
...
<Admonition type="info" title="A Production Cloud Cluster" id="a-production-cloud-cluster" href="#a-production-cloud-cluster">
