...
<Admonition type="info" title="Setting Cloud Configurations via Studio" id="setting-cloud-configurations-via-studio" href="#setting-cloud-configurations-via-studio">
...
<Admonition type="info" title="Indexing Settings" id="indexing-settings" href="#indexing-settings">
