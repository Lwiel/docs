...
<Admonition type="info" title="Akka.Persistence.RavenDB" id="akka-persistence-ravendb" href="#akka-persistence-ravendb">
...
<Admonition type="info" title="Installing the RavenDB persistence plugin" id="installing-the-ravendb-persistence-plugin" href="#installing-the-ravendb-persistence-plugin">
...
<Admonition type="info" title="Configuring the RavenDB persistence plugin with HOCON" id="configuring-the-ravendb-persistence-plugin-with-hocon" href="#configuring-the-ravendb-persistence-plugin-with-hocon"> 
...
<TabItem value="something-something" label="hocon_config">
...
<Admonition type="info" title="Configuring the RavenDB persistence plugin with Hosting" id="configuring-the-ravendb-persistence-plugin-with-hosting" href="#configuring-the-ravendb-persistence-plugin-with-hosting">
...
<TabItem value="something-something" label="basic_hosting_config">
<CodeBlock language="csharp">
