...
<Admonition type="info" title="Anchor multiple documents to the same bucket as a specific document" id="anchor-multiple-documents-to-the-same-bucket-as-a-specific-document" href="#anchor-multiple-documents-to-the-same-bucket-as-a-specific-document">
...
<Admonition type="info" title="Anchor multiple documents using a common suffix" id="anchor-multiple-documents-using-a-common-suffix" href="#anchor-multiple-documents-using-a-common-suffix">
...
<TabItem value="something" label="storeInvoiceInOrderBucketExplicitNaming">
...
<TabItem value="something" label="storeInvoiceInOrderBucketNamingConvention">
<CodeBlock language="csharp">
