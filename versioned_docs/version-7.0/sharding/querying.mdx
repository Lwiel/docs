...
<Admonition type="info" title="Querying a sharded database" id="querying-a-sharded-database" href="#querying-a-sharded-database">
...
<Admonition type="info" title="Querying selected shards" id="querying-selected-shards" href="#querying-selected-shards">
...
<Admonition type="info" title="Including items" id="including-items" href="#including-items">
...
<Admonition type="info" title="Paging results" id="paging-results" href="#paging-results">
...
<Admonition type="info" title="Filtering results" id="filtering-results" href="#filtering-results">
...
<Admonition type="info" title="Querying Map-Reduce indexes" id="querying-map-reduce-indexes" href="#querying-map-reduce-indexes">
...
<TabItem value="something" label="map-reduce-index">
<CodeBlock language="csharp">
{`Reduce = results =>
...
<TabItem value="something" label="OrderBy_with-no-limit">
<CodeBlock language="csharp">
...
<TabItem value="something" label="OrderBy_with-limit">
<CodeBlock language="csharp">
{`var queryResult = session.Query<UserMapReduce.Result, UserMapReduce>()
        .OrderBy(x => x.Name)
...
<TabItem value="something" label="compute-sum-by-retrieved-results">
<CodeBlock language="csharp">
{`var queryResult = session.Query<UserMapReduce.Result, UserMapReduce>()
        .OrderBy(x => x.Sum)
...
<Admonition type="info" title="Timing queries" id="timing-queries" href="#timing-queries">
...
<Admonition type="info" title="Unsupported querying features" id="unsupported-querying-features" href="#unsupported-querying-features">
