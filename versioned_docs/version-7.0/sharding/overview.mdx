...
<Admonition type="info" title="Sharding" id="sharding" href="#sharding">
...
<Admonition type="info" title="Shards" id="shards" href="#shards">
...
<Admonition type="info" title="How documents are distributed among shards" id="how-documents-are-distributed-among-shards" href="#how-documents-are-distributed-among-shards">
...
<Admonition type="info" title="Resharding" id="resharding" href="#resharding">
...
<Admonition type="info" title="Paging" id="paging" href="#paging">
...
<Admonition type="info" title="Using local IP addresses" id="using-local-ip-addresses" href="#using-local-ip-addresses">
...
<Admonition type="info" title="Creating a sharded database" id="creating-a-sharded-database" href="#creating-a-sharded-database">
