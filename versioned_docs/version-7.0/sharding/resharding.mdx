...
<Admonition type="info" title="Change Vector on a Sharded Database" id="change-vector-on-a-sharded-database" href="#change-vector-on-a-sharded-database">
...
<Admonition type="info" title="Resharding and Other Features" id="resharding-and-other-features" href="#resharding-and-other-features">
...
<Admonition type="info" title="Executing Resharding" id="executing-resharding" href="#executing-resharding">
