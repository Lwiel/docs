...
<Admonition type="info" title="The AI Connection Strings view" id="the-ai-connection-strings-view" href="#the-ai-connection-strings-view">
...
<Admonition type="info" title="Creating an AI connection string" id="creating-an-ai-connection-string" href="#creating-an-ai-connection-string">
