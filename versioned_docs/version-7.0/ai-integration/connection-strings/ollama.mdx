...
<Admonition type="info" title="Define the connection string - from the Studio" id="define-the-connection-string-from-the-studio" href="#define-the-connection-string-from-the-studio">

![connection string to ollama](./assets/ollama.png)
...
<Admonition type="info" title="Define the connection string - from the Client API" id="define-the-connection-string-from-the-client-api" href="#define-the-connection-string-from-the-client-api">

<TabItem value="something-something" label="create_connection_string_ollama">
...
<TabItem value="something-something" label="ollama_settings">
<CodeBlock language="csharp">
