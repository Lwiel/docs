...
<Admonition type="info" title="Migration to RavenDB `7.x`" id="migration-to-ravendb-7-x" href="#migration-to-ravendb-7-x">
...
<Admonition type="info" title="Migration from RavenDB 5.x to 6.x" id="migration-from-ravendb-5-x-to-6-x" href="#migration-from-ravendb-5-x-to-6-x">
...
<Admonition type="info" title="Migration from RavenDB 4.x to RavenDB 5.x and 6.x" id="migration-from-ravendb-4-x-to-ravendb-5-x-and-6-x" href="#migration-from-ravendb-4-x-to-ravendb-5-x-and-6-x">
...
<Admonition type="info" title="Migration from RavenDB 3.x" id="migration-from-ravendb-3-x" href="#migration-from-ravendb-3-x">
...
<Admonition type="info" title="Migrating data into a sharded database" id="migrating-data-into-a-sharded-database" href="#migrating-data-into-a-sharded-database">
