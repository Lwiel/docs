...
<Admonition type="info" title="Open RabbitMQ ETL Task View" id="open-rabbitmq-etl-task-view" href="#open-rabbitmq-etl-task-view">
...
<Admonition type="info" title="Define RabbitMQ ETL Task" id="define-rabbitmq-etl-task" href="#define-rabbitmq-etl-task">
...
<Admonition type="info" title="Options Per Exchange" id="options-per-exchange" href="#options-per-exchange">
