...
<Admonition type="info" title="Open Azure Queue Storage ETL task view" id="open-azure-queue-storage-etl-task-view" href="#open-azure-queue-storage-etl-task-view">
...
<Admonition type="info" title="Define Azure Queue Storage ETL task" id="define-azure-queue-storage-etl-task" href="#define-azure-queue-storage-etl-task">
...
<Admonition type="info" title="Authentication method" id="authentication-method" href="#authentication-method">
...
<Admonition type="info" title="Options per queue" id="options-per-queue" href="#options-per-queue">
...
<Admonition type="info" title="Add transformation script" id="add-transformation-script" href="#add-transformation-script">
