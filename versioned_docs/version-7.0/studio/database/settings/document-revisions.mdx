...
<Admonition type="info" title="Document revisions view" id="document-revisions-view" href="#document-revisions-view">
...
<Admonition type="info" title="Revisions configuration" id="revisions-configuration" href="#revisions-configuration">
...
<Admonition type="info" title="Define default configuration" id="define-default-configuration" href="#define-default-configuration">
...
<Admonition type="info" title="Define collection-specific configuration" id="define-collection-specific-configuration" href="#define-collection-specific-configuration">
...
<Admonition type="info" title="Edit conflicting document defaults" id="edit-conflicting-document-defaults" href="#edit-conflicting-document-defaults">
...
* To see these revisions, open the document's [Revisions tab](../../../studio/database/document-extensions/revisions/revisions#revisions-tab).  
...
<Admonition type="info" title="Enforce configuration" id="enforce-configuration" href="#enforce-configuration">
