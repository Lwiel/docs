...
<Admonition type="info" title="Open Index History Dialog" id="open-index-history-dialog" href="#open-index-history-dialog">
...
<Admonition type="info" title="Index History Dialog" id="index-history-dialog" href="#index-history-dialog">
...
<Admonition type="info" title="Select and Load an Index Revision" id="select-and-load-an-index-revision" href="#select-and-load-an-index-revision">
...
<Admonition type="info" title="View and Update Number of Index Revisions" id="view-and-update-number-of-index-revisions" href="#view-and-update-number-of-index-revisions">
