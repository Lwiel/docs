...
<Admonition type="info" title="Admin Logs view" id="admin-logs-view" href="#admin-logs-view">
...
<Admonition type="info" title="Logs on this view" id="logs-on-this-view" href="#logs-on-this-view">
...
<Admonition type="info" title="Logs on disk" id="logs-on-disk" href="#logs-on-disk">
...
<Admonition type="info" title="Log stream" id="log-stream" href="#log-stream">
...
<Admonition type="info" title="Syntax for filter conditions" id="syntax-for-filter-conditions" href="#syntax-for-filter-conditions">
