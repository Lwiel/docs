...
<Admonition type="info" title="The Certificates view" id="the-certificates-view" href="#the-certificates-view">
...
<Admonition type="info" title="View and edit certificates" id="view-and-edit-certificates" href="#view-and-edit-certificates">
...
<Admonition type="info" title="Generate a client certificate" id="generate-a-client-certificate" href="#generate-a-client-certificate"> 
...
<Admonition type="info" title="Enable communication between secure servers" id="enable-communication-between-secure-servers" href="#enable-communication-between-secure-servers"> 
...
<Admonition type="info" title="Certificate collections" id="certificate-collections" href="#certificate-collections"> 
