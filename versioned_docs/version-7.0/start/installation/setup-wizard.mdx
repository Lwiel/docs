...
<Admonition type="info" title="Select Setup Mode" id="select-setup-mode" href="#select-setup-mode">
...
<Admonition type="info" title="Secure Setup with a Free Let's Encrypt Certificate" id="secure-setup-with-a-free-let-s-encrypt-certificate" href="#secure-setup-with-a-free-let-s-encrypt-certificate">
...
<Admonition type="info" title="Secure Setup with Your Own Certificate" id="secure-setup-with-your-own-certificate" href="#secure-setup-with-your-own-certificate">
...
<Admonition type="info" title="Unsecure Setup" id="unsecure-setup" href="#unsecure-setup">
