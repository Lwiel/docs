...
<Admonition type="info" title="Linux or Windows?" id="linux-or-windows" href="#linux-or-windows">
...
<Admonition type="info" title="Document Store Lifetime and Cold Starts" id="document-store-lifetime-and-cold-starts" href="#document-store-lifetime-and-cold-starts">
