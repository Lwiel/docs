...
<Admonition type="info" title="Create a Cloudflare RavenDB Worker project" id="create-a-cloudflare-ravendb-worker-project" href="#create-a-cloudflare-ravendb-worker-project">
...
<Admonition type="info" title="Updating Database Connection Settings" id="updating-database-connection-settings" href="#updating-database-connection-settings">
...
<Admonition type="info" title="Connecting to an Authenticated RavenDB Cluster" id="connecting-to-an-authenticated-ravendb-cluster" href="#connecting-to-an-authenticated-ravendb-cluster">
...
<Admonition type="info" title="Deploying to Production" id="deploying-to-production" href="#deploying-to-production">
...
<Admonition type="info" title="Using RavenDB in the Worker" id="using-ravendb-in-the-worker" href="#using-ravendb-in-the-worker">
