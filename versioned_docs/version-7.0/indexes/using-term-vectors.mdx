...
<TabItem value="something-something" label="term_vectors_3">
<CodeBlock language="java">
...
<Admonition type="info" title="Creating an index and enabling Term Vectors on a field" id="creating-an-index-and-enabling-term-vectors-on-a-field" href="#creating-an-index-and-enabling-term-vectors-on-a-field">
...
<TabItem value="something" label="term_vectors_3">
<CodeBlock language="csharp">
{`public enum FieldTermVector
\{
    /// <summary>
