...
<Admonition type="info" title="Highlight results - Map index" id="highlight-results-map-index" href="#highlight-results-map-index">
...
<TabItem value="something" label="highlight_7">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Highlight results - Map-Reduce index" id="highlight-results-map-reduce-index" href="#highlight-results-map-reduce-index">
...
<TabItem value="something" label="highlight_11">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Customize highlight tags" id="customize-highlight-tags" href="#customize-highlight-tags">
...
<TabItem value="something-something" label="highlights_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="highlight_7">
<CodeBlock language="python">
...
<TabItem value="something-something" label="highlight_11">
<CodeBlock language="python">
...
<TabItem value="something-something" label="highlight_3">
<CodeBlock language="nodejs">
{`// 'employeesResults' contains all Employee DOCUMENTS that contain the term 'manager'.
// 'managerHighlights' contains the text FRAGMENTS that highlight the 'manager' term.
...
<TabItem value="something-something" label="highlight_5">
<CodeBlock language="nodejs">
{`// 'detailsPerCountry' contains the contacts details grouped per country.
// 'agentHighlights' contains the text FRAGMENTS that highlight the 'agent' term.
