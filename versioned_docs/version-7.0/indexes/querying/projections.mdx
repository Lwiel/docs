...
<Admonition type="info" title="Projection behavior with a static-index" id="projection-behavior-with-a-static-index" href="#projection-behavior-with-a-static-index">
...
<Admonition type="info" title="What are Projections and When to Use Them" id="what-are-projections-and-when-to-use-them" href="#what-are-projections-and-when-to-use-them">
...
<Admonition type="info" title="Projection Behavior" id="projection-behavior" href="#projection-behavior">
...
<Admonition type="info" title="Projections and the Session" id="projections-and-the-session" href="#projections-and-the-session">
...
<TabItem value="something-something" label="syntax_select_fields">
<CodeBlock language="python">
{`def select_fields(
    self,
...
<TabItem value="something-something" label="ProjectionBehavior_syntax">
<CodeBlock language="python">
