...
<Admonition type="info" title="Creating Map Reduce Indexes" id="creating-map-reduce-indexes" href="#creating-map-reduce-indexes">
...
<Admonition type="info" title="Creating Multi-Map-Reduce Indexes" id="creating-multi-map-reduce-indexes" href="#creating-multi-map-reduce-indexes">
...
<TabItem value="something-something" label="multi_map_reduce_LINQ">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="multi-map-reduce-index-query">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Reduce Results as Artificial Documents" id="reduce-results-as-artificial-documents" href="#reduce-results-as-artificial-documents">
...
<TabItem value="something-something" label="syntax_0">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="map_reduce_4_0">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Important Comments" id="important-comments" href="#important-comments">
...
In this example, we will count an average product price for each category.  
The index definition:  
<TabItem value="something-something" label="map_reduce_1_0">
<CodeBlock language="nodejs">
...
We want to know how many times each product was ordered and how much we earned for it.  
In order to extract that information, we need to define the following index:  
<TabItem value="something-something" label="map_reduce_2_0">
<CodeBlock language="nodejs">
