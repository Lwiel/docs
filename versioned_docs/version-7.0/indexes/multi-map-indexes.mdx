...
<Admonition type="info" title="AddMap & AddMapForAll" id="addmap-addmapforall" href="#addmap-addmapforall">
...
<Admonition type="info" title="Searching across multiple collections" id="searching-across-multiple-collections" href="#searching-across-multiple-collections">
...
<TabItem value="something" label="multi_map_1_0">
<CodeBlock language="csharp">
...
and query it using:
<TabItem value="something" label="multi_map_1_1">
<CodeBlock language="csharp">
...
<Admonition type="info" title="AddMap" id="addmap" href="#addmap">
...
To search for products, companies, or employees by their name, you need to define the following index:
<TabItem value="something-something" label="multi_map_1_0">
<CodeBlock language="java">
...
and query it using:
<TabItem value="something-something" label="multi_map_1_1">
<CodeBlock language="java">
...
<Admonition type="info" title="`_add_map`" id="_add_map" href="#_add_map">
...
<Admonition type="info" title="Indexing multiple collections" id="indexing-multiple-collections" href="#indexing-multiple-collections">
...
<TabItem value="something-something" label="multiMapIndex_1">
<CodeBlock language="nodejs">
...
To search for products, companies, or employees by their name, you need to define the following index:
<TabItem value="something-something" label="multiMapIndex_2">
<CodeBlock language="nodejs">
