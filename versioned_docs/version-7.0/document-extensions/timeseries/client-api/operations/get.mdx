...
<Admonition type="info" title="Get entries - from single time series" id="get-entries-from-single-time-series" href="#get-entries-from-single-time-series">
...
<Admonition type="info" title="Get entries - from multiple time series" id="get-entries-from-multiple-time-series" href="#get-entries-from-multiple-time-series">
