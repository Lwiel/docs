...
<TabItem value="something" label="timeseries_region_Use-BulkInsert-To-Append-single-entry">
...
<TabItem value="something" label="timeseries_region_Use-BulkInsert-To-Append-100-Entries">
<CodeBlock language="csharp">
{`using (BulkInsertOperation bulkInsert = store.BulkInsert())
\{
    using (TimeSeriesBulkInsert timeSeriesBulkInsert =
...
<TabItem value="something" label="BulkInsert-overload-2-Two-HeartRate-Sets">
<CodeBlock language="csharp">
{`using (BulkInsertOperation bulkInsert = store.BulkInsert())
\{
    using (TimeSeriesBulkInsert timeSeriesBulkInsert =
...
<TabItem value="something" label="timeseries_region_Use-BulkInsert-To-Append-multiple-timeseries">
<CodeBlock language="csharp">
{`using (BulkInsertOperation bulkInsert = store.BulkInsert())
\{
...
<TabItem value="something" label="Append-Operation-Definition-1">
<CodeBlock language="csharp">
...
<TabItem value="something" label="Append-Operation-Definition-2">
<CodeBlock language="csharp">
...
In this example, we append a single entry with a single value to time series "HeartRates". 
<TabItem value="something-something" label="append_1">
...
In this example, we append 100 entries with a single value to time series "HeartRates". 
<TabItem value="something-something" label="append_2">
<CodeBlock language="nodejs">
{`const baseTime = new Date();
...
In this example, we append multiple values per entry in time series "HeartRates".
<TabItem value="something-something" label="append_3">
<CodeBlock language="nodejs">
{`const baseTime = new Date();
...
In this example, we append multiple time series in different documents in the same batch.
<TabItem value="something-something" label="append_4">
<CodeBlock language="nodejs">
{`const baseTime = new Date();
