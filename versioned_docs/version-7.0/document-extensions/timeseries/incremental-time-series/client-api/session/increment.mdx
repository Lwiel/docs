...
<Admonition type="info" title="`IncrementalTimeSeriesFor.Increment`" id="incrementaltimeseriesfor-increment" href="#incrementaltimeseriesfor-increment">
...
<TabItem value="something" label="incremental_declaration_increment-values-array-at-provided-timestamp">
...
<TabItem value="something" label="incremental_declaration_increment-values-array-at-current-time">
<CodeBlock language="csharp">
{`// Increment a time series entry's array of values at the current time
...
<TabItem value="something" label="incremental_declaration_increment-value-at-provided-timestamp">
<CodeBlock language="csharp">
{`// Increment an entry value at the provided timestamp
...
`}
   ...
   * Increment an entry value at the current time.  
     (If the entry exists and has more than one value, only the first 
     value in its list will be incremented by the passed value.)  
<TabItem value="something" label="incremental_declaration_increment-value-at-current-time">
<CodeBlock language="csharp">
{`// Increment an entry value at the current time
...
<Admonition type="info" title="Usage Flow" id="usage-flow" href="#usage-flow">
...
<Admonition type="info" title="Code Samples" id="code-samples" href="#code-samples">

* Increment an array of values in an incremental time series entry.  
<TabItem value="something" label="incremental_create-incremental-time-series">
<CodeBlock language="csharp">
