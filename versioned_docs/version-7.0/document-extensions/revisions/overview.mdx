...
<Admonition type="info" title="How it works" id="how-it-works" href="#how-it-works">
...
<Admonition type="info" title="Revisions storage" id="revisions-storage" href="#revisions-storage">
...
<Admonition type="info" title="Force revision creation" id="force-revision-creation" href="#force-revision-creation">
...
<TabItem value="something-something" label="force_revision_creation_for">
