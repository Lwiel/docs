...
<Admonition type="info" title="Revisions Store Operations" id="revisions-store-operations" href="#revisions-store-operations">
...
<Admonition type="info" title="Revisions Session methods" id="revisions-session-methods" href="#revisions-session-methods">
