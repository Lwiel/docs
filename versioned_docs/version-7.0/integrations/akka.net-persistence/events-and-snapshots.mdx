...
<Admonition type="info" title="Storing events" id="storing-events" href="#storing-events">
...
<Admonition type="info" title="Storing snapshots" id="storing-snapshots" href="#storing-snapshots">
...
<Admonition type="info" title="Storing guidelines" id="storing-guidelines" href="#storing-guidelines">
...
<Admonition type="info" title="Global consistency" id="global-consistency" href="#global-consistency">
...
<Admonition type="info" title="Sample application" id="sample-application" href="#sample-application">
