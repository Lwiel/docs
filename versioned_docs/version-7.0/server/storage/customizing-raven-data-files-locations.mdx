...
<Admonition type="info" title="Why store data on different devices" id="why-store-data-on-different-devices" href="#why-store-data-on-different-devices">
...
<Admonition type="info" title="Configuring temp files location" id="configuring-temp-files-location" href="#configuring-temp-files-location">
...
<Admonition type="info" title="Configuring data files location" id="configuring-data-files-location" href="#configuring-data-files-location">
...
<Admonition type="info" title="Automate storage definitions" id="automate-storage-definitions" href="#automate-storage-definitions">
