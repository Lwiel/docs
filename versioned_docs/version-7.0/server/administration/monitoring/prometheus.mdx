...
<Admonition type="info" title="Prometheus" id="prometheus" href="#prometheus">
...
<Admonition type="info" title="RavenDB Prometheus Endpoint" id="ravendb-prometheus-endpoint" href="#ravendb-prometheus-endpoint">
...
<Admonition type="info" title="Using the RavenDB Endpoint by a Prometheus Server" id="using-the-ravendb-endpoint-by-a-prometheus-server" href="#using-the-ravendb-endpoint-by-a-prometheus-server">
