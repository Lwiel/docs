...
<Admonition type="info" title="Server statistics" id="server-statistics" href="#server-statistics">
...
<Admonition type="info" title="Database statistics" id="database-statistics" href="#database-statistics">
