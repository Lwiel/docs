...
<Admonition type="info" title="Scheduling Document Archival" id="scheduling-document-archival" href="#scheduling-document-archival">
...
<Admonition type="info" title="Archival and Other Features" id="archival-and-other-features" href="#archival-and-other-features">
...
<TabItem value="something" label="overrideDefaultIndexConfiguration">
...
<TabItem value="something" label="applyAdditionalLogic">
<CodeBlock language="csharp">
{`store.Maintenance.Send(new PutIndexesOperation(new[] \{
new IndexDefinition
\{
...
<TabItem value="something" label="useIndexDefinitionBuilder">
<CodeBlock language="csharp">
...
<TabItem value="something" label="useAbstractIndexCreationTask">
<CodeBlock language="csharp">
...
<TabItem value="something" label="dataSubscriptionDefinition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="smugglerOption">
<CodeBlock language="csharp">
{`var operation =
...
<Admonition type="info" title="Archiving and Patching" id="archiving-and-patching" href="#archiving-and-patching">
...
<TabItem value="something" label="archiveByPatch">
<CodeBlock language="csharp">
...
<TabItem value="something" label="unarchiveByPatch">
<CodeBlock language="csharp">
...
<TabItem value="something" label="unarchiveUsingAutoIndex">
<CodeBlock language="csharp">
{`var operation =
    await store.Operations.SendAsync(
        new PatchByQueryOperation(new IndexQuery()
...
<TabItem value="something" label="unarchiveCollectionQuery">
<CodeBlock language="csharp">
{`var operation =
    await store.Operations.SendAsync(
        new PatchByQueryOperation(new IndexQuery()
...
<Admonition type="info" title="Enabling Archiving and Setting Scan Frequency" id="enabling-archiving-and-setting-scan-frequency" href="#enabling-archiving-and-setting-scan-frequency">
...
<TabItem value="something" label="enableArchivingAndSetFrequency">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Default (Server/Database) Configuration Options" id="default-server-database-configuration-options" href="#default-server-database-configuration-options">
