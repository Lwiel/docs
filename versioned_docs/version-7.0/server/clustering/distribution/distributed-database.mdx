...
<Admonition type="info" title="The Database Record" id="the-database-record" href="#the-database-record">
...
<Admonition type="info" title="Replication Factor" id="replication-factor" href="#replication-factor">
...
<Admonition type="info" title="Database Topology" id="database-topology" href="#database-topology">
...
<Admonition type="info" title="Dynamic Database Distribution" id="dynamic-database-distribution" href="#dynamic-database-distribution">
