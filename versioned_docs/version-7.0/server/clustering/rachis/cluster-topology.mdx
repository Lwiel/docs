...
<Admonition type="info" title="Fetching the topology" id="fetching-the-topology" href="#fetching-the-topology">
...
<Admonition type="info" title="Modifying the topology" id="modifying-the-topology" href="#modifying-the-topology">
...
<Admonition type="info" title="Nodes states and types" id="nodes-states-and-types" href="#nodes-states-and-types">
...
Can be assigned with databases and tasks. See more [below](../../../server/clustering/rachis/cluster-topology#watcher). |
...
<Admonition type="info" title="Changing Node Type" id="changing-node-type" href="#changing-node-type">
