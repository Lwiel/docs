...
<Admonition type="info" title="About numbers" id="about-numbers" href="#about-numbers">
...
<TabItem value="something" label="interstellar_trip">
...
<Admonition type="info" title="Numbers in documents" id="numbers-in-documents" href="#numbers-in-documents">
...
<Admonition type="info" title="Numbers in JavaScript engine" id="numbers-in-javascript-engine" href="#numbers-in-javascript-engine">
...
<TabItem value="something" label="query_with_big_number_projection">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Numbers in indexes and queries" id="numbers-in-indexes-and-queries" href="#numbers-in-indexes-and-queries">  
...
<TabItem value="something" label="interstellar_static_index">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Numbers in management studio" id="numbers-in-management-studio" href="#numbers-in-management-studio">
...
<Admonition type="info" title="Numbers in client API" id="numbers-in-client-api" href="#numbers-in-client-api">
