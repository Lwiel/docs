...
<TabItem value="something" label="add_kafka_connection_string">
...
<TabItem value="something" label="kafka_con_str_settings">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Add a Kafka ETL task" id="add-a-kafka-etl-task" href="#add-a-kafka-etl-task">
...
<TabItem value="something" label="add_kafka_etl_task">
<CodeBlock language="csharp">
...
<TabItem value="something" label="kafka_delete_documents">
<CodeBlock language="csharp">
{`var etlTask = new QueueEtlConfiguration()
\{
    BrokerType = QueueBrokerType.Kafka,
