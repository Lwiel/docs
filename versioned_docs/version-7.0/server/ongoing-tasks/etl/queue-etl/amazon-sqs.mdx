...
<Admonition type="info" title="RavenDB ETL and Amazon SQS" id="ravendb-etl-and-amazon-sqs" href="#ravendb-etl-and-amazon-sqs">
...
<Admonition type="info" title="Queue methods" id="queue-methods" href="#queue-methods">
...
<TabItem value="something" label="sqs_fifo">
...
<TabItem value="something" label="add_sqs_connection_string">
<CodeBlock language="csharp">
...
<TabItem value="something" label="amazon_sqs_con_str_settings">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Add an Amazon SQS ETL task" id="add-an-amazon-sqs-etl-task" href="#add-an-amazon-sqs-etl-task">
...
<TabItem value="something" label="add_amazon_sqs_etl_task">
<CodeBlock language="csharp">
...
<TabItem value="something" label="sqs_delete_documents">
<CodeBlock language="csharp">
{`var etlTask = new QueueEtlConfiguration()
\{
    BrokerType = QueueBrokerType.AmazonSqs,
...
<Admonition type="info" title="The transformation script" id="the-transformation-script" href="#the-transformation-script">
