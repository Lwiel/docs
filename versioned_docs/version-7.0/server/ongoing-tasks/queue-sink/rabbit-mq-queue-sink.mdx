...
<Admonition type="info" title="The RabbitMQ Sink Task" id="the-rabbitmq-sink-task" href="#the-rabbitmq-sink-task">
...
<TabItem value="something" label="add_RabbitMq_connection-string">
...
`}
    ...
    `QueueBrokerType`:  
<TabItem value="something" label="QueueBrokerType">
<CodeBlock language="csharp">
...
<TabItem value="something" label="define-rabbitmq-sink-script">
<CodeBlock language="csharp">
...
**Code Sample**:  
<TabItem value="something" label="add_kafka_sink-task">
<CodeBlock language="csharp">
