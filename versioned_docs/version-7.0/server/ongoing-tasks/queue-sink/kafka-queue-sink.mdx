...
<Admonition type="info" title="The Queue Sink Task" id="the-queue-sink-task" href="#the-queue-sink-task">
...
<TabItem value="something" label="add_kafka_connection-string">
...
<TabItem value="something" label="define-kafka-sink-script">
<CodeBlock language="csharp">
