...
<Admonition type="info" title="Code Sample" id="code-sample" href="#code-sample">
...
<TabItem value="something" label="ExternalReplication">
...
<TabItem value="something" label="ExternalReplicationWithMentorAndDelay">
<CodeBlock language="csharp">
...
<TabItem value="something" label="ExternalReplicationProperties">
<CodeBlock language="csharp">
{`public class ExternalReplication
\{
    public TimeSpan DelayReplicationFor \{ get; set; \}
