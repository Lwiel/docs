...
<Admonition type="info" title="Provide incident description" id="provide-incident-description" href="#provide-incident-description">
...
<Admonition type="info" title="Create debug package" id="create-debug-package" href="#create-debug-package">
...
<Admonition type="info" title="Enable logs for ongoing issues" id="enable-logs-for-ongoing-issues" href="#enable-logs-for-ongoing-issues">
...
<Admonition type="info" title="Download logs" id="download-logs" href="#download-logs">
...
<Admonition type="info" title="Reproduce scenario" id="reproduce-scenario" href="#reproduce-scenario">
...
<Admonition type="info" title="Create failing test" id="create-failing-test" href="#create-failing-test">
