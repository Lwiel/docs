...
<Admonition type="info" title="Using The Initial Client Certificate" id="using-the-initial-client-certificate" href="#using-the-initial-client-certificate">
...
<Admonition type="info" title="Using Additional Certificates" id="using-additional-certificates" href="#using-additional-certificates">
...
<Admonition type="info" title="Enable MFA" id="enable-mfa" href="#enable-mfa">
