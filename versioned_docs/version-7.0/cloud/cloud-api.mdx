...
<Admonition type="info" title="Swagger & available clients" id="swagger-available-clients" href="#swagger-available-clients">
...
<Admonition type="info" title="API methods overview" id="api-methods-overview" href="#api-methods-overview">
...
<Admonition type="info" title="API Keys expiration" id="api-keys-expiration" href="#api-keys-expiration">
...
<Admonition type="info" title="Product quota" id="product-quota" href="#product-quota">
