...
<Admonition type="info" title="Available support options" id="available-support-options" href="#available-support-options">
...
<Admonition type="info" title="Severity and response time types" id="severity-and-response-time-types" href="#severity-and-response-time-types">
