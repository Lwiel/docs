...
<Admonition type="info" title="Provisioning a New Product" id="provisioning-a-new-product" href="#provisioning-a-new-product">
...
<Admonition type="info" title="View the Product Metrics" id="view-the-product-metrics" href="#view-the-product-metrics">
...
<Admonition type="info" title="View the Cluster Health" id="view-the-cluster-health" href="#view-the-cluster-health">
...
<Admonition type="info" title="Managing an Existing Product" id="managing-an-existing-product" href="#managing-an-existing-product">
...
!["Figure 14 - Manage Product: Storage"](./assets/portal-product-details-edit-storage.png)
...
!["Figure 15 - Manage Product: Manage access"](./assets/portal-product-details-manage-access.png)
...
* **See audit logs**
  ...
  !["Figure 16 - See audit logs"](./assets/portal-product-details-audit-logs.png)

* **Edit**  
  Click this button to edit your product's list of Allowed IPs.

  !["Figure 17 - Manage Product: Edit IPs"](./assets/portal-product-details-allowed-ips.png)
...
!["Figure 18 - Manage Features: Enable features"](./assets/portal-product-features-disabled.png)
