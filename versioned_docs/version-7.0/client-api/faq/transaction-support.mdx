...
<Admonition type="info" title="ACID storage" id="acid-storage" href="#acid-storage">
...
<Admonition type="info" title="What is and what isn't a transaction" id="what-is-and-what-isn-t-a-transaction" href="#what-is-and-what-isn-t-a-transaction">
...
<Admonition type="info" title="Working with transactions in RavenDB" id="working-with-transactions-in-ravendb" href="#working-with-transactions-in-ravendb">
...
<Admonition type="info" title="ACID for document operations" id="acid-for-document-operations" href="#acid-for-document-operations">
...
<Admonition type="info" title="BASE for query operations" id="base-for-query-operations" href="#base-for-query-operations">
