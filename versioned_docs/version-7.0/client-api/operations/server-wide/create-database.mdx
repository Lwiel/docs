...
<Admonition type="info" title="Create new database" id="create-new-database" href="#create-new-database">
...
<TabItem value="something-something" label="create_database_operation_syntax">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="builder_syntax">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="CreateDatabase">
...
<TabItem value="something-something" label="EnsureDatabaseExists">
<CodeBlock language="java">
...
<TabItem value="something-something" label="create_database_syntax">
<CodeBlock language="java">
{`public CreateDatabaseOperation(DatabaseRecord databaseRecord)
