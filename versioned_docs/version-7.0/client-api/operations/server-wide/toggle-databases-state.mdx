...
<Admonition type="info" title="Enable/Disable database from the Client API" id="enable-disable-database-from-the-client-api" href="#enable-disable-database-from-the-client-api">
...
<Admonition type="info" title="Disable database via the file system" id="disable-database-via-the-file-system" href="#disable-database-via-the-file-system">
