...
<Admonition type="info" title="Resume indexing example" id="resume-indexing-example" href="#resume-indexing-example">
...
<TabItem value="something-something" label="start_1">
...
<TabItem value="something-something" label="start_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="resume_indexing">
