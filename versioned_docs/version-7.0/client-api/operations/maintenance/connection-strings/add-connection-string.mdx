...
<Admonition type="info" title="Add a RavenDB connection string" id="add-a-ravendb-connection-string" href="#add-a-ravendb-connection-string">
...
#### Syntax:
<TabItem value="something" label="raven_connection_string">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Add an SQL connection string" id="add-an-sql-connection-string" href="#add-an-sql-connection-string">
...
<Admonition type="info" title="Add a Snowflake connection string" id="add-a-snowflake-connection-string" href="#add-a-snowflake-connection-string">
...
#### Example:
<TabItem value="something" label="add_snowflake_connection_string">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Add an OLAP connection string" id="add-an-olap-connection-string" href="#add-an-olap-connection-string">
...
<Admonition type="info" title="Add an Elasticsearch connection string" id="add-an-elasticsearch-connection-string" href="#add-an-elasticsearch-connection-string">
...
<Admonition type="info" title="Add a Kafka connection string" id="add-a-kafka-connection-string" href="#add-a-kafka-connection-string">
...
<Admonition type="info" title="Add a RabbitMQ connection string" id="add-a-rabbitmq-connection-string" href="#add-a-rabbitmq-connection-string">
...
<Admonition type="info" title="Add an Azure Queue Storage connection string" id="add-an-azure-queue-storage-connection-string" href="#add-an-azure-queue-storage-connection-string">
...
<Admonition type="info" title="Add an Amazon SQS connection string" id="add-an-amazon-sqs-connection-string" href="#add-an-amazon-sqs-connection-string">
...
<Admonition type="info" title="The&nbsp;`PutConnectionStringOperation`&nbsp;method" id="the-nbsp-putconnectionstringoperation-nbsp-method" href="#the-nbsp-putconnectionstringoperation-nbsp-method">
...
<TabItem value="something" label="connection_string_class">
<CodeBlock language="csharp">
