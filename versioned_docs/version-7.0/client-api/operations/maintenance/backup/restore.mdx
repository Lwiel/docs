...
<Admonition type="info" title="Restoring a Database: Configuration and Execution" id="restoring-a-database-configuration-and-execution" href="#restoring-a-database-configuration-and-execution">
...
<TabItem value="something" label="restore_restorebackupconfiguration">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Optional Settings" id="optional-settings" href="#optional-settings">
...
<TabItem value="something" label="restore_last_file_name_to_restore">
<CodeBlock language="csharp">
...
<TabItem value="something" label="restore_to_specific__data_directory">
<CodeBlock language="csharp">
...
<TabItem value="something" label="restore_disable_ongoing_tasks_true">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Restore Database to a Single Node" id="restore-database-to-a-single-node" href="#restore-database-to-a-single-node">
...
* **Code Sample**:  
<TabItem value="something" label="restore_to_single_node">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Restore Database to Multiple Nodes" id="restore-database-to-multiple-nodes" href="#restore-database-to-multiple-nodes">
