...
<Admonition type="info" title="Operations that can be executed lazily" id="operations-that-can-be-executed-lazily" href="#operations-that-can-be-executed-lazily">
...
<Admonition type="info" title="Multiple lazy requests " id="multiple-lazy-requests" href="#multiple-lazy-requests">
