...
<Admonition type="info" title="Defer commands example" id="defer-commands-example" href="#defer-commands-example">
...
<Admonition type="info" title="Commands that can be deferred" id="commands-that-can-be-deferred" href="#commands-that-can-be-deferred">
