...
<Admonition type="info" title="Get tracked entities " id="get-tracked-entities" href="#get-tracked-entities">

**Tracking stored entities**:
<TabItem value="something" label="get_tracked_entities_1">
...
<TabItem value="something" label="get_tracked_entities_2">
<CodeBlock language="csharp">
{`using (var session = store.OpenSession())
\{
    // Load entity:
...
<TabItem value="something" label="get_tracked_entities_3">
<CodeBlock language="csharp">
{`using (var session = store.OpenSession())
\{
...
**Tracking stored entities**:
<TabItem value="something-something" label="get_tracked_entities_1">
...
**Tracking loaded and deleted entities**:
<TabItem value="something-something" label="get_tracked_entities_2">
<CodeBlock language="nodejs">
{`const session = documentStore.openSession();
...
**Tracking queried entities**:
<TabItem value="something-something" label="get_tracked_entities_3">
<CodeBlock language="nodejs">
{`const session = documentStore.openSession();
