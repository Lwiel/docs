...
<Admonition type="info" title="Load a document & update" id="load-a-document-update" href="#load-a-document-update">
...
<Admonition type="info" title="Query for documents & update" id="query-for-documents-update" href="#query-for-documents-update">
