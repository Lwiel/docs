...
<Admonition type="info" title="Atomic guard creation and update" id="atomic-guard-creation-and-update" href="#atomic-guard-creation-and-update">
...
<Admonition type="info" title="Atomic guard usage example" id="atomic-guard-usage-example" href="#atomic-guard-usage-example">
...
<Admonition type="info" title="Atomic guard database scope" id="atomic-guard-database-scope" href="#atomic-guard-database-scope">
...
<Admonition type="info" title="Disabling atomic guards" id="disabling-atomic-guards" href="#disabling-atomic-guards">
...
<Admonition type="info" title="When are atomic guards removed" id="when-are-atomic-guards-removed" href="#when-are-atomic-guards-removed">
...
<Admonition type="info" title="Best practice when storing a document in a cluster-wide transaction" id="best-practice-when-storing-a-document-in-a-cluster-wide-transaction" href="#best-practice-when-storing-a-document-in-a-cluster-wide-transaction">
...
<TabItem value="something-something" label="atomic_guards_enabled">
...
<TabItem value="something-something" label="atomic_guards_disabled">
<CodeBlock language="python">
{`with store.open_session(
    # Open a cluster-wide session
...
<TabItem value="something-something" label="load_before_storing">
<CodeBlock language="python">
{`with store.open_session(
    session_options=SessionOptions(
        # Open a cluster-wide session
