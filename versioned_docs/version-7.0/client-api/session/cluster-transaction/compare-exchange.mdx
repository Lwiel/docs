...
<Admonition type="info" title="Create compare-exchange" id="create-compare-exchange" href="#create-compare-exchange">
...
<Admonition type="info" title="Get compare-exchange" id="get-compare-exchange" href="#get-compare-exchange">
...
<Admonition type="info" title="Delete compare-exchange" id="delete-compare-exchange" href="#delete-compare-exchange">
...
<TabItem value="something-something" label="new_compare_exchange_sync">
...
<TabItem value="something-something" label="methods_3_sync">
<CodeBlock language="python">
...
<TabItem value="something-something" label="methods_1_sync">
<CodeBlock language="python">
...
<TabItem value="something-something" label="methods_2_sync">
<CodeBlock language="python">
...
<TabItem value="something-something" label="methods_sync_lazy_1">
<CodeBlock language="python">
{`# Single value
...
<TabItem value="something-something" label="methods_4_sync">
<CodeBlock language="python">
{`# Delete by key & index
...
<TabItem value="something-something" label="create_compare_exchange_example">
...
<TabItem value="something-something" label="create_compare_exchange">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="get_compare_exchange_1">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="get_compare_exchange_2">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="get_compare_exchange_3">
<CodeBlock language="nodejs">
{`// Single item
...
<TabItem value="something-something" label="delete_compare_exchange">
<CodeBlock language="nodejs">
{`// Delete by key & index
session.advanced.clusterTransaction.deleteCompareExchangeValue(key, index);
