...
<Admonition type="info" title="Open a cluster transaction" id="open-a-cluster-transaction" href="#open-a-cluster-transaction">
...
<Admonition type="info" title="Cluster-wide transaction vs. Single-node transaction" id="cluster-wide-transaction-vs-single-node-transaction" href="#cluster-wide-transaction-vs-single-node-transaction">
...
<TabItem value="something-something" label="open_cluster_session_sync">
