...
<Admonition type="info" title="Queries always provide results using an index" id="queries-always-provide-results-using-an-index" href="#queries-always-provide-results-using-an-index"> 
...
<Admonition type="info" title="Session.Query" id="session-query" href="#session-query">
...
<Admonition type="info" title="Session.Advanced.DocumentQuery" id="session-advanced-documentquery" href="#session-advanced-documentquery">
...
<Admonition type="info" title="Session.Advanced.RawQuery" id="session-advanced-rawquery" href="#session-advanced-rawquery">
...
<Admonition type="info" title="Custom methods and extensions for LINQ" id="custom-methods-and-extensions-for-linq" href="#custom-methods-and-extensions-for-linq">
...
<Admonition type="info" title="session.advanced.document_query" id="session-advanced-document_query" href="#session-advanced-document_query">
...
<Admonition type="info" title="session.advanced.raw_query" id="session-advanced-raw_query" href="#session-advanced-raw_query">
...
<Admonition type="info" title="Custom methods" id="custom-methods" href="#custom-methods">
...
<Admonition type="info" title="query API" id="query-api" href="#query-api">
