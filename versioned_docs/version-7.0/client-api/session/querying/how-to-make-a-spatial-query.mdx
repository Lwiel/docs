...
<Admonition type="info" title="Search by radius" id="search-by-radius" href="#search-by-radius">
...
<Admonition type="info" title="Search by shape" id="search-by-shape" href="#search-by-shape">
...
<Admonition type="info" title="Spatial sorting" id="spatial-sorting" href="#spatial-sorting">
...
<TabItem value="something" label="spatial_4_getDistance">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Spatial API" id="spatial-api" href="#spatial-api">

#### `Spatial`

<TabItem value="something" label="spatial_7">
<CodeBlock language="csharp">
...
<TabItem value="something" label="spatial_8">
<CodeBlock language="csharp">
{`PointField Point(
...
<TabItem value="something" label="spatial_9">
<CodeBlock language="csharp">
...
<TabItem value="something" label="spatial_10">
<CodeBlock language="csharp">
{`// From point
...
<TabItem value="something" label="spatial_11">
<CodeBlock language="csharp">
{`// From point
...
<Admonition type="info" title="Spatial" id="spatial" href="#spatial">

<TabItem value="something-something" label="spatial_1">
...
<TabItem value="something-something" label="spatial_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="spatial_3">
<CodeBlock language="java">
...
<Admonition type="info" title="OrderByDistance" id="orderbydistance" href="#orderbydistance">

To sort by distance from given point use the `orderByDistance` method. The closest results will come first.

<TabItem value="something-something" label="spatial_6">
<CodeBlock language="java">
...
<Admonition type="info" title="OrderByDistanceDescending" id="orderbydistancedescending" href="#orderbydistancedescending">

To sort by distance from given point use the `OrderByDistanceDescending` method. The farthest results will come first.

<TabItem value="something-something" label="spatial_8">
<CodeBlock language="java">
...
<TabItem value="something-something" label="spatial_4_getDistance">
<CodeBlock language="python">
{`# Get the distance of the results:
# ================================
...
<TabItem value="something-something" label="spatial_7">
<CodeBlock language="python">
{`def spatial(
    self,
    field_name_or_field: Union[str, DynamicSpatialField],
...
<TabItem value="something-something" label="spatial_9">
<CodeBlock language="python">
...
<TabItem value="something-something" label="spatial_10">
<CodeBlock language="python">
{`# From point & rounding
...
<TabItem value="something-something" label="spatial_11">
<CodeBlock language="python">
{`# From point & rounding
