...
<Admonition type="info" title="Query with exact match" id="query-with-exact-match" href="#query-with-exact-match">
...
<Admonition type="info" title="Query with exact match - nested object" id="query-with-exact-match-nested-object" href="#query-with-exact-match-nested-object">
...
<TabItem value="something-something" label="query_1_0">
