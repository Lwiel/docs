...
<Admonition type="info" title="Lazy query" id="lazy-query" href="#lazy-query">
...
<Admonition type="info" title="Lazy count query" id="lazy-count-query" href="#lazy-count-query">
...
<Admonition type="info" title="Lazy suggestions query" id="lazy-suggestions-query" href="#lazy-suggestions-query">
...
<Admonition type="info" title="Lazy facets query" id="lazy-facets-query" href="#lazy-facets-query">
...
<Admonition type="info" title="Lazily" id="lazily" href="#lazily">

<TabItem value="something-something" label="lazy_1">
...
<TabItem value="something-something" label="lazy_2">
<CodeBlock language="java">
...
<Admonition type="info" title="Counts" id="counts" href="#counts">

<TabItem value="something-something" label="lazy_4">
<CodeBlock language="java">
...
<TabItem value="something-something" label="lazy_5">
<CodeBlock language="java">
...
<Admonition type="info" title="Suggestions" id="suggestions" href="#suggestions">

<TabItem value="something-something" label="lazy_6">
<CodeBlock language="java">
...
<TabItem value="something-something" label="lazy_7">
<CodeBlock language="java">
...
<Admonition type="info" title="Facets" id="facets" href="#facets">

<TabItem value="something-something" label="lazy_8">
<CodeBlock language="java">
...
<TabItem value="something-something" label="lazy_9">
<CodeBlock language="java">
...
<Admonition type="info" title="Lazy aggregation" id="lazy-aggregation" href="#lazy-aggregation">
...
<TabItem value="something-something" label="lazy_3">
<CodeBlock language="nodejs">
{`// Define a lazy suggestion query
