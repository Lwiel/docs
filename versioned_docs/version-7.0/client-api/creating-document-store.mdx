...
---
<Admonition type="info" title="Creating a Document Store - Configuration" id="creating-a-document-store-configuration" href="#creating-a-document-store-configuration">
...
<TabItem value="something" label="disable_certificate_cleanup">
...
<Admonition type="info" title="Creating a Document Store - Example" id="creating-a-document-store-example" href="#creating-a-document-store-example">
...
<TabItem value="something" label="document_store_holder">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="document_store_creation">
...
<TabItem value="something-something" label="document_store_holder">
<CodeBlock language="java">
...
<TabItem value="something-something" label="document_store_ctor">
