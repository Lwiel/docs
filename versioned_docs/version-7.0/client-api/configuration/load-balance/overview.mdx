...
<Admonition type="info" title="Keeping the client topology up-to-date" id="keeping-the-client-topology-up-to-date" href="#keeping-the-client-topology-up-to-date">
...
<Admonition type="info" title="Client logic for choosing a node" id="client-logic-for-choosing-a-node" href="#client-logic-for-choosing-a-node">
...
<Admonition type="info" title="The preferred node" id="the-preferred-node" href="#the-preferred-node">
...
<Admonition type="info" title="Single-node session usage" id="single-node-session-usage" href="#single-node-session-usage">
