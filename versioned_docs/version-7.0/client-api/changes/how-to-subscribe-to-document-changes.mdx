...
<Admonition type="info" title="ForDocument" id="fordocument" href="#fordocument">

Single document changes can be observed using `ForDocument` method.

### Syntax

<TabItem value="something" label="document_changes_1">
...
<TabItem value="something" label="document_changes_2">
<CodeBlock language="csharp">
...
<Admonition type="info" title="ForDocumentsInCollection" id="fordocumentsincollection" href="#fordocumentsincollection">
...
<TabItem value="something" label="document_changes_3">
<CodeBlock language="csharp">
...
<TabItem value="something" label="document_changes_4">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
...
<TabItem value="something" label="document_changes_5">
<CodeBlock language="csharp">
...
<Admonition type="info" title="ForDocumentsStartingWith" id="fordocumentsstartingwith" href="#fordocumentsstartingwith">

To observe all document changes for documents with ID that contains given prefix use `ForDocumentsStartingWith` method.

### Syntax

<TabItem value="something" label="document_changes_9">
<CodeBlock language="csharp">
...
<TabItem value="something" label="document_changes_1_0">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
...
<Admonition type="info" title="ForAllDocuments" id="foralldocuments" href="#foralldocuments">

To observe all document changes use `ForAllDocuments` method.

### Syntax

<TabItem value="something" label="document_changes_1_1">
<CodeBlock language="csharp">
...
<TabItem value="something" label="document_changes_1_2">
<CodeBlock language="csharp">
{`IDisposable subscription = store
    .Changes()
...
<Admonition type="info" title="DocumentChange" id="documentchange" href="#documentchange">
...
<Admonition type="info" title="DocumentChangeTypes" id="documentchangetypes" href="#documentchangetypes">
...
<TabItem value="something-something" label="document_changes_1">
...
<TabItem value="something-something" label="document_changes_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="document_changes_3">
<CodeBlock language="java">
{`IChangesObservable<DocumentChange> forDocumentsInCollection(String collectionName);
...
<TabItem value="something-something" label="document_changes_4">
<CodeBlock language="java">
...
<TabItem value="something-something" label="document_changes_5">
<CodeBlock language="java">
...
<TabItem value="something-something" label="document_changes_9">
<CodeBlock language="java">
{`IChangesObservable<DocumentChange> forDocumentsStartingWith(String docIdPrefix);
`}
</CodeBlock>
...
<TabItem value="something-something" label="document_changes_1_0">
<CodeBlock language="java">
{`CleanCloseable subscription = store
    .changes()
    .forDocumentsStartingWith("employees/1") // employees/1, employees/10, employees/11, etc.
...
<TabItem value="something-something" label="document_changes_1_1">
<CodeBlock language="java">
{`IChangesObservable<DocumentChange> forAllDocuments();
`}
</CodeBlock>
...
<TabItem value="something-something" label="document_changes_1_2">
<CodeBlock language="java">
{`CleanCloseable subscription = store
    .changes()
    .forAllDocuments()
