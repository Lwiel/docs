...
<Admonition type="info" title="Selecting the search engine" id="selecting-the-search-engine" href="#selecting-the-search-engine">
...
<TabItem value="something-something" label="index-definition_select-while-creating-index">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="index-definition_set-search-engine-type">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Unsupported features" id="unsupported-features" href="#unsupported-features">
...
<Admonition type="info" title="Handling of complex JSON objects" id="handling-of-complex-json-objects" href="#handling-of-complex-json-objects">
...
<TabItem value="something-something" label="index-definition_disable-indexing-for-specified-field">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Compound fields" id="compound-fields" href="#compound-fields">
...
<Admonition type="info" title="Limits" id="limits" href="#limits">
...
<Admonition type="info" title="Configuration options" id="configuration-options" href="#configuration-options">
...
<Admonition type="info" title="Index training: Compression dictionaries" id="index-training-compression-dictionaries" href="#index-training-compression-dictionaries">
