...
<Admonition type="info" title="Include explanations when querying Map index" id="include-explanations-when-querying-map-index" href="#include-explanations-when-querying-map-index">
...
<Admonition type="info" title="Include explanations when querying Map-Reduce index" id="include-explanations-when-querying-map-reduce-index" href="#include-explanations-when-querying-map-reduce-index">
