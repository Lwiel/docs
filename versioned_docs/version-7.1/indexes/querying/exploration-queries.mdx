...
<Admonition type="info" title="`filter`" id="filter" href="#filter">
...
<Admonition type="info" title="When should exploration queries be used" id="when-should-exploration-queries-be-used" href="#when-should-exploration-queries-be-used">
...
<Admonition type="info" title="Usage examples" id="usage-examples" href="#usage-examples">
...
Use `filter` with a collection query to scan and filter the entire collection.  
<TabItem value="something-something" label="exploration-queries_1.3">
...
Use `filter` after a `where` clause to filter the results retrieved by an index query.  
<TabItem value="something-something" label="exploration-queries_2.3">
<CodeBlock language="python">
{`emp = (
...
The filtered results can be projected using `select`, like those of any other query.  
<TabItem value="something-something" label="exploration-queries_3.3">
<CodeBlock language="python">
