...
<Admonition type="info" title="Simple index - Single index-entry per document" id="simple-index-single-index-entry-per-document" href="#simple-index-single-index-entry-per-document">
...
<Admonition type="info" title="Fanout index - Multiple index-entries per document" id="fanout-index-multiple-index-entries-per-document" href="#fanout-index-multiple-index-entries-per-document">
