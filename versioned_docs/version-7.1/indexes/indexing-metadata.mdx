...
<Admonition type="info" title="Indexing metadata properties" id="indexing-metadata-properties" href="#indexing-metadata-properties">
...
<Admonition type="info" title="Metadata properties that can be indexed" id="metadata-properties-that-can-be-indexed" href="#metadata-properties-that-can-be-indexed">
