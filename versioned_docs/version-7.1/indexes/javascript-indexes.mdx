...
<Admonition type="info" title="Creating and deploying a JavaScript index" id="creating-and-deploying-a-javascript-index" href="#creating-and-deploying-a-javascript-index">
...
<Admonition type="info" title="Map index" id="map-index" href="#map-index">
...
<Admonition type="info" title="Multi-Map index" id="multi-map-index" href="#multi-map-index">
...
<Admonition type="info" title="Map-Reduce index" id="map-reduce-index" href="#map-reduce-index">
