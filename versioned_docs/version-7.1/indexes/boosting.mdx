...
<Admonition type="info" title="Assign a boost factor to an index-field" id="assign-a-boost-factor-to-an-index-field" href="#assign-a-boost-factor-to-an-index-field">
...
<Admonition type="info" title="Assign a boost factor to the index-entry" id="assign-a-boost-factor-to-the-index-entry" href="#assign-a-boost-factor-to-the-index-entry">
...
<Admonition type="info" title="Automatic score-based ordering" id="automatic-score-based-ordering" href="#automatic-score-based-ordering">
...
<Admonition type="info" title="Corax vs Lucene: boosting differences" id="corax-vs-lucene-boosting-differences" href="#corax-vs-lucene-boosting-differences">
...
<TabItem value="something-something" label="boosting_3">
<CodeBlock language="java">
