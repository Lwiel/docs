...
<Admonition type="info" title="Prepare Terraform Configuration" id="prepare-terraform-configuration" href="#prepare-terraform-configuration">
...
<Admonition type="info" title="Apply Terraform Configuration" id="apply-terraform-configuration" href="#apply-terraform-configuration">
