...
<Admonition type="info" title="Revert single document" id="revert-single-document" href="#revert-single-document">
...
<Admonition type="info" title="Revert multiple documents" id="revert-multiple-documents" href="#revert-multiple-documents">
