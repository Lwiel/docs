...
<Admonition type="info" title="Time series architecture" id="time-series-architecture" href="#time-series-architecture">
...
<Admonition type="info" title="Updating Time Series" id="updating-time-series" href="#updating-time-series">
