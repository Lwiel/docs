...
<Admonition type="info" title="Creating and Removing Time Series" id="creating-and-removing-time-series" href="#creating-and-removing-time-series">
...
<Admonition type="info" title="`session` Methods -vs- `document-store` Operations" id="session-methods-vs-document-store-operations" href="#session-methods-vs-document-store-operations">
...
<Admonition type="info" title="Available Time Series `session` methods" id="available-time-series-session-methods" href="#available-time-series-session-methods">
...
<Admonition type="info" title="Available Time Series `store` Operations" id="available-time-series-store-operations" href="#available-time-series-store-operations">
