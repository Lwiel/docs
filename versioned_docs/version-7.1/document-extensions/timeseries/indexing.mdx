...
<Admonition type="info" title="Time series indexes vs Document indexes" id="time-series-indexes-vs-document-indexes" href="#time-series-indexes-vs-document-indexes">
...
<Admonition type="info" title="Ways to create a time series index" id="ways-to-create-a-time-series-index" href="#ways-to-create-a-time-series-index">
...
<Admonition type="info" title="Examples of time series indexes" id="examples-of-time-series-indexes" href="#examples-of-time-series-indexes">
