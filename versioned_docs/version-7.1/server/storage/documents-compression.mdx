...
<Admonition type="info" title="Compression -vs- Compaction" id="compression-vs-compaction" href="#compression-vs-compaction">
...
<Admonition type="info" title="Set compression for all collections" id="set-compression-for-all-collections" href="#set-compression-for-all-collections">
...
<Admonition type="info" title="Set compression for selected collections" id="set-compression-for-selected-collections" href="#set-compression-for-selected-collections">
