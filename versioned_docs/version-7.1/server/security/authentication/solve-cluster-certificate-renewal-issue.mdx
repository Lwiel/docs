...
<Admonition type="info" title="Background and Current Situation" id="background-and-current-situation" href="#background-and-current-situation">
...
<Admonition type="info" title="Solutions" id="solutions" href="#solutions">
