...
<Admonition type="info" title="Cluster Admin" id="cluster-admin" href="#cluster-admin">
...
<Admonition type="info" title="Operator" id="operator" href="#operator">
...
<Admonition type="info" title="User" id="user" href="#user">
