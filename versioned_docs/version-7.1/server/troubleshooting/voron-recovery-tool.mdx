...
<Admonition type="info" title="How to run it" id="how-to-run-it" href="#how-to-run-it">
...
<Admonition type="info" title="Additional flags" id="additional-flags" href="#additional-flags">
