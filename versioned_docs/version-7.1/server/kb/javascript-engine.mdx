...
<Admonition type="info" title="How RavenDB uses Jint" id="how-ravendb-uses-jint" href="#how-ravendb-uses-jint">
...
<Admonition type="info" title="Predefined JavaScript functions" id="predefined-javascript-functions" href="#predefined-javascript-functions">
...
| **put(documentId, document, [optional]changeVectorString)** | `Task`       | Creates or updates a document with the specified ID.<br/>To generate a new document ID, you can use the _"collectionPrefix/[Server-Side ID](../../server/kb/document-identifier-generation#strategy--2)"_ notation&lt;sup&gt;[[ex]](../../client-api/operations/patching/single-document#add-document)&lt;/sup&gt;.
This function can also clone an existing document.<br/>Note: attachments & counters will not be included in the clone&lt;sup&gt;[[ex]](../../client-api/operations/patching/single-document#clone-document)&lt;/sup&gt;. Used in patching. |
