...
<Admonition type="info" title="Enabling OpenTelemetry in RavenDB" id="enabling-opentelemetry-in-ravendb" href="#enabling-opentelemetry-in-ravendb">
...
<Admonition type="info" title="RavenDB OpenTelemetry meters" id="ravendb-opentelemetry-meters" href="#ravendb-opentelemetry-meters">
...
<Admonition type="info" title="Server identification in metrics" id="server-identification-in-metrics" href="#server-identification-in-metrics">
...
<Admonition type="info" title="The metric instruments" id="the-metric-instruments" href="#the-metric-instruments">
...
<Admonition type="info" title="Metrics export options" id="metrics-export-options" href="#metrics-export-options">
...
<Admonition type="info" title="Configuring the OpenTelemetry Collector" id="configuring-the-opentelemetry-collector" href="#configuring-the-opentelemetry-collector">
