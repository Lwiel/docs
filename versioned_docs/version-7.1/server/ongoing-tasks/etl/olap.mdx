...
<Admonition type="info" title="Transform Script" id="transform-script" href="#transform-script">
...
<TabItem value="something" label="script">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Athena Examples" id="athena-examples" href="#athena-examples">
