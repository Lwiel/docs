...
<Admonition type="info" title="Creating a Task" id="creating-a-task" href="#creating-a-task">
...
<Admonition type="info" title="Snowflake warehouse setup" id="snowflake-warehouse-setup" href="#snowflake-warehouse-setup">
...
<Admonition type="info" title="Snowflake Tables" id="snowflake-tables" href="#snowflake-tables">
...
<Admonition type="info" title="Transformation Scripts" id="transformation-scripts" href="#transformation-scripts">
...
<Admonition type="info" title="Transaction Processing" id="transaction-processing" href="#transaction-processing">
...
<Admonition type="info" title="Advanced Options" id="advanced-options" href="#advanced-options">
