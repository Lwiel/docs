...
<Admonition type="info" title="Backup Type" id="backup-type" href="#backup-type">
...
<Admonition type="info" title="Backup Contents" id="backup-contents" href="#backup-contents">
...
<Admonition type="info" title="Backup Scope: Full or Incremental" id="backup-scope-full-or-incremental" href="#backup-scope-full-or-incremental">
...
<Admonition type="info" title="Backup Name and Folder Structure" id="backup-name-and-folder-structure" href="#backup-name-and-folder-structure">
...
<Admonition type="info" title="Encryption" id="encryption" href="#encryption">

Stored backup data can be [Encrypted](../../client-api/operations/maintenance/backup/encrypted-backup) or Unencrypted.  

</Admonition>

<Admonition type="info" title="Compression" id="compression" href="#compression">
...
<Admonition type="info" title="Retention Policy" id="retention-policy" href="#retention-policy">
...
<Admonition type="info" title="Restoration Procedure" id="restoration-procedure" href="#restoration-procedure">
