...
<Admonition type="info" title="Add node to the cluster" id="add-node-to-the-cluster" href="#add-node-to-the-cluster">
...
<Admonition type="info" title="Delete node from the cluster" id="delete-node-from-the-cluster" href="#delete-node-from-the-cluster">
...
<Admonition type="info" title="Promote a Node" id="promote-a-node" href="#promote-a-node">
...
<Admonition type="info" title="Demote a Node" id="demote-a-node" href="#demote-a-node">
...
<Admonition type="info" title="Force Elections" id="force-elections" href="#force-elections">
...
<Admonition type="info" title="Force Timeout" id="force-timeout" href="#force-timeout">
...
<Admonition type="info" title="Bootstrap Cluster" id="bootstrap-cluster" href="#bootstrap-cluster">
