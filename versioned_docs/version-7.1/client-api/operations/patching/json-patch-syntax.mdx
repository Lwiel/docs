...
<Admonition type="info" title="JSON Patches " id="json-patches" href="#json-patches">
...
<Admonition type="info" title="Running JSON Patches" id="running-json-patches" href="#running-json-patches">
...
<Admonition type="info" title="Patch Operations" id="patch-operations" href="#patch-operations">
...
<TabItem value="something" label="json_patch_Add_operation">
...
<TabItem value="something" label="json_patch_Remove_operation">
<CodeBlock language="csharp">
...
<TabItem value="something" label="json_patch_Replace_operation">
<CodeBlock language="csharp">
{`patchesDocument = new JsonPatchDocument();
...
<TabItem value="something" label="json_patch_Copy_operation">
<CodeBlock language="csharp">
{`patchesDocument = new JsonPatchDocument();
...
<TabItem value="something" label="json_patch_Move_operation">
<CodeBlock language="csharp">
{`patchesDocument = new JsonPatchDocument();
...
<TabItem value="something" label="json_patch_Test_operation">
<CodeBlock language="csharp">
{`patchesDocument = new JsonPatchDocument();
...
<Admonition type="info" title="Additional JSON Patching Options" id="additional-json-patching-options" href="#additional-json-patching-options">
...
<TabItem value="something" label="json_patch_Add_array_element">
<CodeBlock language="csharp">
{`patchesDocument = new JsonPatchDocument();
