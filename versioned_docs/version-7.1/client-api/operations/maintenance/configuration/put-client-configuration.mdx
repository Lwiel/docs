...
<Admonition type="info" title="Client configuration overview and modification" id="client-configuration-overview-and-modification" href="#client-configuration-overview-and-modification">
...
<Admonition type="info" title="What can be configured" id="what-can-be-configured" href="#what-can-be-configured">
...
<Admonition type="info" title="Put client configuration (for database)" id="put-client-configuration-for-database" href="#put-client-configuration-for-database">

<TabItem value="something" label="put_config_1">
...
<TabItem value="something" label="put_config_2">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="config_2_0">
...
<TabItem value="something-something" label="config_2_2">
<CodeBlock language="java">
{`ClientConfiguration clientConfiguration = new ClientConfiguration();
...
<TabItem value="something-something" label="put_config_1">
...
<TabItem value="something-something" label="put_config_2">
<CodeBlock language="python">
{`# Override the initial client-configuration in the server using the put operation:
# ================================================================================
with document_store:
