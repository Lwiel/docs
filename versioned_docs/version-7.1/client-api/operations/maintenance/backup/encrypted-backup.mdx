...
<Admonition type="info" title="RavenDB's Security Approach" id="ravendb-s-security-approach" href="#ravendb-s-security-approach">
...
<TabItem value="something" label="encrypted_database">
...
<Admonition type="info" title="Backup-Encryption Overview" id="backup-encryption-overview" href="#backup-encryption-overview">
...
<TabItem value="something" label="BackupEncryptionSettings_definition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="EncryptionMode_definition">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Creating an Encrypted Logical-Backup" id="creating-an-encrypted-logical-backup" href="#creating-an-encrypted-logical-backup">
...
<TabItem value="something" label="use_database_encryption_key_full_sample">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Creating an Encrypted Snapshot" id="creating-an-encrypted-snapshot" href="#creating-an-encrypted-snapshot">
...
* To create an **Encrypted Snapshot** (For an encrypted database) -  
  **Set** `EncryptionMode = EncryptionMode.UseDatabaseKey`  
  Or  
  **Don't set** EncryptionMode & Key at all - Default value is: `EncryptionMode.UseDatabaseKey`  
<TabItem value="something" label="encrypted_snapshot">
<CodeBlock language="csharp">
{`var config = new PeriodicBackupConfiguration
\{
    //Additional settings here..
...
<Admonition type="info" title="Restoring an Encrypted Backup" id="restoring-an-encrypted-backup" href="#restoring-an-encrypted-backup">
...
<TabItem value="something" label="restore_encrypted_backup">
<CodeBlock language="csharp">
...
<TabItem value="something" label="restore_encrypted_database">
<CodeBlock language="csharp">
...
<TabItem value="something" label="restore_unencrypted_database">
<CodeBlock language="csharp">
{`restoreConfiguration.BackupEncryptionSettings = new BackupEncryptionSettings
\{
    //No encryption
