...
<Admonition type="info" title="Disable index from the Client API" id="disable-index-from-the-client-api" href="#disable-index-from-the-client-api">
...
<Admonition type="info" title="Disable index manually via the file system" id="disable-index-manually-via-the-file-system" href="#disable-index-manually-via-the-file-system">
...
<Admonition type="note" title="Note">
Unlike [StopIndex](../../../../client-api/operations/maintenance/indexes/stop-index) or [StopIndexing](../../../../client-api/operations/maintenance/indexes/stop-indexing) disable index is a persistent operation, so the index remains disabled even after a server restart.
</Admonition>


## Syntax

<TabItem value="something-something" label="disable_1">
...
<TabItem value="something-something" label="disable_2">
<CodeBlock language="java">
