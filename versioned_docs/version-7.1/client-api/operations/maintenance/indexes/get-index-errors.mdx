...
<Admonition type="info" title="Get errors for all indexes" id="get-errors-for-all-indexes" href="#get-errors-for-all-indexes">
...
<Admonition type="info" title="Get errors for specific indexes" id="get-errors-for-specific-indexes" href="#get-errors-for-specific-indexes">
