...
<Admonition type="info" title="Get ongoing task info" id="get-ongoing-task-info" href="#get-ongoing-task-info">

For the examples in this article, let's create a simple external replication ongoing task:

<TabItem value="something-something" label="create_task">
...
<Admonition type="info" title="Delete ongoing task" id="delete-ongoing-task" href="#delete-ongoing-task">
...
<Admonition type="info" title="Toggle ongoing task state" id="toggle-ongoing-task-state" href="#toggle-ongoing-task-state">
...
<TabItem value="something" label="syntax_5">
<CodeBlock language="csharp">
