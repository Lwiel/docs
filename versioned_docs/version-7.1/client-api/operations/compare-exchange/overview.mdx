...
<Admonition type="info" title="What Compare Exchange Items Are" id="what-compare-exchange-items-are" href="#what-compare-exchange-items-are">
...
<Admonition type="info" title="Creating and Managing Compare-Exchange Items" id="creating-and-managing-compare-exchange-items" href="#creating-and-managing-compare-exchange-items">
...
<Admonition type="info" title="Why Compare-Exchange Items are Not Replicated to External Databases " id="why-compare-exchange-items-are-not-replicated-to-external-databases" href="#why-compare-exchange-items-are-not-replicated-to-external-databases">
...
<Admonition type="info" title="Example I - Email Address Reservation" id="example-i-email-address-reservation" href="#example-i-email-address-reservation">  
...
<Admonition type="info" title="Example II - Reserve a Shared Resource" id="example-ii-reserve-a-shared-resource" href="#example-ii-reserve-a-shared-resource">  
...
<Admonition type="info" title="Example III - Ensuring Unique Values without Using Compare Exchange" id="example-iii-ensuring-unique-values-without-using-compare-exchange" href="#example-iii-ensuring-unique-values-without-using-compare-exchange">  
...
<Admonition type="info" title="Compare Exchange Transaction Scope" id="compare-exchange-transaction-scope" href="#compare-exchange-transaction-scope">
...
<Admonition type="info" title="Creating a Key" id="creating-a-key" href="#creating-a-key">
...
<Admonition type="info" title="Updating a Key" id="updating-a-key" href="#updating-a-key">
