...
<Admonition type="info" title="Add database node - random" id="add-database-node-random" href="#add-database-node-random">
...
<Admonition type="info" title="Add database node - specific" id="add-database-node-specific" href="#add-database-node-specific">
...
<TabItem value="something-something" label="add_1">
...
<TabItem value="something-something" label="add_2">
<CodeBlock language="python">
{`# Create the AddDatabaseNodeOperation
