...
<Admonition type="info" title="Put client-configuration (server-wide)" id="put-client-configuration-server-wide" href="#put-client-configuration-server-wide">
...
<TabItem value="something-something" label="put_config">
