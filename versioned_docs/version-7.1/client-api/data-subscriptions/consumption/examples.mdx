...
<Admonition type="info" title="Client with full exception handling and processing retries" id="client-with-full-exception-handling-and-processing-retries" href="#client-with-full-exception-handling-and-processing-retries">
...
<Admonition type="info" title="Worker with a specified batch size" id="worker-with-a-specified-batch-size" href="#worker-with-a-specified-batch-size">
...
<Admonition type="info" title="Worker that operates with a session" id="worker-that-operates-with-a-session" href="#worker-that-operates-with-a-session">
...
<Admonition type="info" title="Worker that processes dynamic objects" id="worker-that-processes-dynamic-objects" href="#worker-that-processes-dynamic-objects">
...
<Admonition type="info" title="Worker that processes a blittable object" id="worker-that-processes-a-blittable-object" href="#worker-that-processes-a-blittable-object">
...
<Admonition type="info" title="Subscription that ends when no documents are left" id="subscription-that-ends-when-no-documents-are-left" href="#subscription-that-ends-when-no-documents-are-left">
...
<Admonition type="info" title="Subscription that uses included documents" id="subscription-that-uses-included-documents" href="#subscription-that-uses-included-documents">
...
<Admonition type="info" title="Subscription workers with failover on other nodes" id="subscription-workers-with-failover-on-other-nodes" href="#subscription-workers-with-failover-on-other-nodes">
...
<Admonition type="info" title="Primary and secondary workers" id="primary-and-secondary-workers" href="#primary-and-secondary-workers">
...
<Admonition type="info" title="Subscription that ends when no documents left" id="subscription-that-ends-when-no-documents-left" href="#subscription-that-ends-when-no-documents-left">
...
<Admonition type="info" title="Worker that processes raw objects" id="worker-that-processes-raw-objects" href="#worker-that-processes-raw-objects">
