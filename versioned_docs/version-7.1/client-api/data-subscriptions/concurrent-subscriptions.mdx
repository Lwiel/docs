...
<Admonition type="info" title="Defining concurrent workers" id="defining-concurrent-workers" href="#defining-concurrent-workers">
...
<Admonition type="info" title="Dropping a connection" id="dropping-a-connection" href="#dropping-a-connection">
...
<Admonition type="info" title="Connection failure" id="connection-failure" href="#connection-failure">
