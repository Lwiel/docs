...
<TabItem value="something" label="aggressive_cache_conventions">
...
<TabItem value="something" label="aggressive_cache_global">
<CodeBlock language="csharp">
...
<TabItem value="something" label="aggressive_cache_load">
<CodeBlock language="csharp">
...
<TabItem value="something" label="aggressive_cache_query">
<CodeBlock language="csharp">
{`using (session.Advanced.DocumentStore.AggressivelyCacheFor(TimeSpan.FromMinutes(5)))
\{
...
<TabItem value="something" label="aggressive_cache_for_one_day_1">
<CodeBlock language="csharp">
...
<TabItem value="something" label="aggressive_cache_for_one_day_2">
<CodeBlock language="csharp">
...
<TabItem value="something" label="disable_change_tracking">
<CodeBlock language="csharp">
...
<TabItem value="something" label="disable_aggressive_cache">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="aggressive_cache_conventions">
...
<TabItem value="something-something" label="aggressive_cache_global">
<CodeBlock language="java">
...
<TabItem value="something-something" label="aggressive_cache_load">
<CodeBlock language="java">
...
<TabItem value="something-something" label="aggressive_cache_query">
<CodeBlock language="java">
{`try (CleanCloseable cacheScope = session.advanced().getDocumentStore()
        .aggressivelyCacheFor(Duration.ofMinutes(5))) \{
...
<TabItem value="something-something" label="aggressive_cache_for_one_day_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="aggressive_cache_for_one_day_2">
<CodeBlock language="java">
{`try (CleanCloseable cacheScope = session
...
<TabItem value="something-something" label="disable_change_tracking">
<CodeBlock language="java">
...
<TabItem value="something-something" label="disable_aggressive_cache">
<CodeBlock language="java">
{`try (CleanCloseable cacheScope = session.advanced().getDocumentStore()
