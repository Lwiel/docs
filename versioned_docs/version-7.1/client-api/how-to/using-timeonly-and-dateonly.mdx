...
<Admonition type="info" title="About DateOnly and TimeOnly" id="about-dateonly-and-timeonly" href="#about-dateonly-and-timeonly">
...
<Admonition type="info" title="Convert and Use Date/TimeOnly Without Affecting Your Existing Data" id="convert-and-use-date-timeonly-without-affecting-your-existing-data" href="#convert-and-use-date-timeonly-without-affecting-your-existing-data">
...
<TabItem value="something" label="IndexConvertsStringsWithAsDateOnlySample">
...
<TabItem value="something" label="AsDateOnlyStringToDateOnlyQuerySample">
<CodeBlock language="csharp">
...
<TabItem value="something" label="IndexConvertsDateTimeWithAsDateOnlySample">
<CodeBlock language="csharp">
{`// Create a Static Index.
...
<TabItem value="something" label="AsDateOnlyDateTimeToDateOnlyQuerySample">
<CodeBlock language="csharp">
{`using (var session = store.OpenSession()) 
\{
...
<Admonition type="info" title="Using already existing DateOnly or TimeOnly fields " id="using-already-existing-dateonly-or-timeonly-fields" href="#using-already-existing-dateonly-or-timeonly-fields">

RavenDB doesn't look for DateOnly or TimeOnly as default types during indexing 
so the index must have a field that declares the type as DateOnly or TimeOnly. 

<TabItem value="something" label="DateAndTimeOnlyIndexSample">
<CodeBlock language="csharp">
...
<TabItem value="something" label="TimeOnly_between15-17">
<CodeBlock language="csharp">
