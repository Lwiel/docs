...
<Admonition type="info" title="Store Events" id="store-events" href="#store-events">
...
<Admonition type="info" title="Store/Session Events" id="store-session-events" href="#store-session-events">
