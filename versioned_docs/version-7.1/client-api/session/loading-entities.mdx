...
<Admonition type="info" title="Load" id="load" href="#load">
...
<Admonition type="info" title="Load with Includes" id="load-with-includes" href="#load-with-includes">
...
<TabItem value="something" label="loading_entities_2_0">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Load - multiple entities" id="load-multiple-entities" href="#load-multiple-entities">
...
<Admonition type="info" title="LoadStartingWith" id="loadstartingwith" href="#loadstartingwith">
...
<Admonition type="info" title="ConditionalLoad" id="conditionalload" href="#conditionalload">
...
<Admonition type="info" title="Stream" id="stream" href="#stream">
...
<Admonition type="info" title="IsLoaded" id="isloaded" href="#isloaded">
...
<TabItem value="something" label="loading_entities_6_0">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="loading_entities_1_0">
...
<TabItem value="something-something" label="loading_entities_1_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_2_0">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_2_1">
<CodeBlock language="java">
{`// loading 'products/1'
// including document found in 'supplier' property
Product product = session
...
<TabItem value="something-something" label="loading_entities_3_0">
<CodeBlock language="java">
{`<TResult> Map<String, TResult> load(Class<TResult> clazz, String... ids);
...
<TabItem value="something-something" label="loading_entities_3_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_4_0">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_4_1">
<CodeBlock language="java">
{`// return up to 128 entities with Id that starts with 'employees'
Employee[] result = session
    .advanced()
...
<TabItem value="something-something" label="loading_entities_4_2">
<CodeBlock language="java">
{`// return up to 128 entities with Id that starts with 'employees/'
// and rest of the key begins with "1" or "2" e.g. employees/10, employees/25
Employee[] result = session
...
<TabItem value="something-something" label="loading_entities_7_0">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_7_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_5_0">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_5_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_5_2">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_6_0">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_6_1">
<CodeBlock language="java">
...
<TabItem value="something-something" label="loading_entities_2_2">
<CodeBlock language="python">
{`# loading 'products/1'
# including document found in 'Supplier' property
products_by_key = session.include("Supplier").load("products/1", Product)
...
<Admonition type="info" title="load_starting_with" id="load_starting_with" href="#load_starting_with">

To load multiple entities with a common prefix, use the `advanced` session operation `load_starting_with`.  
<TabItem value="something-something" label="load_starting_with">
<CodeBlock language="python">
...
<Admonition type="info" title="load_starting_with_into_stream" id="load_starting_with_into_stream" href="#load_starting_with_into_stream">
...
<TabItem value="something-something" label="load_starting_with_into_stream">
<CodeBlock language="python">
...
<Admonition type="info" title="conditional_load" id="conditional_load" href="#conditional_load">
...
<Admonition type="info" title="is_loaded" id="is_loaded" href="#is_loaded">
...
<Admonition type="info" title="`load` with `include`" id="load-with-include" href="#load-with-include">
...
<TabItem value="something-something" label="loading_entities_8">
<CodeBlock language="nodejs">
{`class Pet \{
    constructor(name) \{
        this.name = name;
