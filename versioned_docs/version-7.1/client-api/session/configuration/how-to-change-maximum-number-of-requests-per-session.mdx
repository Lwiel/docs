...
<TabItem value="something" label="max_requests_1">
...
<TabItem value="something" label="max_requests_2">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="max_requests_1">
...
<TabItem value="something-something" label="max_requests_2">
<CodeBlock language="java">
