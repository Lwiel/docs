...
<Admonition type="info" title="Check for session changes " id="check-for-session-changes" href="#check-for-session-changes">
...
<Admonition type="info" title="Get session changes " id="get-session-changes" href="#get-session-changes">
...
<Admonition type="info" title="HasChanges" id="haschanges" href="#haschanges">

Property indicates if the session contains any changes. If there are any new, changed or deleted entities.

<TabItem value="something-something" label="what_changed_1">
...
<TabItem value="something-something" label="what_changed_2">
<CodeBlock language="java">
...
<Admonition type="info" title="WhatChanged" id="whatchanged" href="#whatchanged">
...
<TabItem value="something-something" label="what_changed_3">
<CodeBlock language="java">
...
<TabItem value="something-something" label="what_changed_4">
<CodeBlock language="java">
{`try (IDocumentSession session = store.openSession()) \{
    Employee employee = new Employee();
...
<TabItem value="something-something" label="what_changed_5">
<CodeBlock language="java">
{`try (IDocumentSession session = store.openSession()) \{
