...
<Admonition type="info" title="Projections overview" id="projections-overview" href="#projections-overview">
...
<Admonition type="info" title="Select" id="select" href="#select">
...
<Admonition type="info" title="ProjectInto" id="projectinto" href="#projectinto">
...
<Admonition type="info" title="SelectFields" id="selectfields" href="#selectfields">
...
<Admonition type="info" title="Single projection per query" id="single-projection-per-query" href="#single-projection-per-query">
...
<Admonition type="info" title="OfType - simple projection" id="oftype-simple-projection" href="#oftype-simple-projection">
...
<Admonition type="info" title="select_fields_query_data" id="select_fields_query_data" href="#select_fields_query_data">
...
<Admonition type="info" title="raw_query with `select`" id="raw_query-with-select" href="#raw_query-with-select">
...
<Admonition type="info" title="select_fields" id="select_fields" href="#select_fields">
...
<Admonition type="info" title="`select`, `selectFields`" id="select-selectfields" href="#select-selectfields">
...
<Admonition type="info" title="`ofType`" id="oftype" href="#oftype">
...
<Admonition type="info" title="Projecting nested object types" id="projecting-nested-object-types" href="#projecting-nested-object-types">
