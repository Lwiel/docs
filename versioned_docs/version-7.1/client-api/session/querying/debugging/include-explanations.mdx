...
<TabItem value="something-something" label="explain_1">
...
<Admonition type="info" title="Include explanations in a query" id="include-explanations-in-a-query" href="#include-explanations-in-a-query">
...
<Admonition type="info" title="View explanations" id="view-explanations" href="#view-explanations">
