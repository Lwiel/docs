...
<Admonition type="info" title="DocumentQuery examples" id="documentquery-examples" href="#documentquery-examples">
...
<Admonition type="info" title="Convert between DocumentQuery and Query" id="convert-between-documentquery-and-query" href="#convert-between-documentquery-and-query">
...
<Admonition type="info" title="Custom Methods and Extensions" id="custom-methods-and-extensions" href="#custom-methods-and-extensions">
...
<Admonition type="info" title="`document_query` Examples" id="document_query-examples" href="#document_query-examples">
...
<Admonition type="info" title="Convert between `document_query` and `query`" id="convert-between-document_query-and-query" href="#convert-between-document_query-and-query">
...
<Admonition type="info" title="Available Custom Methods and Extensions" id="available-custom-methods-and-extensions" href="#available-custom-methods-and-extensions">
