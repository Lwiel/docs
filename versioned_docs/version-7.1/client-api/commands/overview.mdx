...
<Admonition type="info" title="Execute command - using the Store Request Executor" id="execute-command-using-the-store-request-executor" href="#execute-command-using-the-store-request-executor">
...
<Admonition type="info" title="Execute command - using the Session Request Executor" id="execute-command-using-the-session-request-executor" href="#execute-command-using-the-session-request-executor">
...
<Admonition type="info" title="Available commands" id="available-commands" href="#available-commands">
