...
<TabItem value="something-something" label="delete_interface">
...
<TabItem value="something-something" label="delete_document_1">
...
<TabItem value="something-something" label="delete_document_2">
<CodeBlock language="nodejs">
{`const command = new DeleteDocumentCommand("employees/1-A", null);
...
<TabItem value="something-something" label="delete_document_3">
<CodeBlock language="nodejs">
{`// Load a document
