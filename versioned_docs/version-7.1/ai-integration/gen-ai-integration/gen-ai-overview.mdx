...
<Admonition type="info" title="RavenDB GenAI tasks" id="ravendb-genai-tasks" href="#ravendb-genai-tasks">
...
<Admonition type="info" title="Run time" id="run-time" href="#run-time">
...
<Admonition type="info" title="Supported services" id="supported-services" href="#supported-services">
