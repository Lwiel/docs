...
<Admonition type="info" title="Defining a Connection string" id="defining-a-connection-string" href="#defining-a-connection-string">
...
<Admonition type="info" title="Defining the GenAI task" id="defining-the-genai-task" href="#defining-the-genai-task">
