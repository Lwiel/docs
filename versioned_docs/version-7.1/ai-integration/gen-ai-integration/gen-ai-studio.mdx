...
<Admonition type="info" title="GenAI Task" id="genai-task" href="#genai-task">
...
<Admonition type="info" title="Add a GenAI Task" id="add-a-genai-task" href="#add-a-genai-task">
...
<Admonition type="info" title="Configure basic settings" id="configure-basic-settings" href="#configure-basic-settings">
...
<Admonition type="info" title="Generate context objects" id="generate-context-objects" href="#generate-context-objects">
...
<Admonition type="info" title="Define Prompt and JSON schema" id="define-prompt-and-json-schema" href="#define-prompt-and-json-schema">
...
<Admonition type="info" title="Provide update script" id="provide-update-script" href="#provide-update-script">
...
<Admonition type="info" title="Review configuration and Save task" id="review-configuration-and-save-task" href="#review-configuration-and-save-task">
