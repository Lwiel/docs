...
<Admonition type="info" title="What is a vector database" id="what-is-a-vector-database" href="#what-is-a-vector-database">
...
<Admonition type="info" title="Why choose RavenDB as your vector database" id="why-choose-ravendb-as-your-vector-database" href="#why-choose-ravendb-as-your-vector-database">
