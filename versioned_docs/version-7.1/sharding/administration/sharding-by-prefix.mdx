...
<Admonition type="info" title="Why use prefixed sharding" id="why-use-prefixed-sharding" href="#why-use-prefixed-sharding">
...
<Admonition type="info" title="Bucket management" id="bucket-management" href="#bucket-management">
...
<Admonition type="info" title="Adding prefixes via Studio" id="adding-prefixes-via-studio" href="#adding-prefixes-via-studio">
...
<Admonition type="info" title="Adding prefixes via Client API" id="adding-prefixes-via-client-api" href="#adding-prefixes-via-client-api">
...
<Admonition type="info" title="Removing prefixes" id="removing-prefixes" href="#removing-prefixes">
...
<Admonition type="info" title="Updating shard configurations for prefixes" id="updating-shard-configurations-for-prefixes" href="#updating-shard-configurations-for-prefixes">
...
<Admonition type="info" title="Querying selected shards by prefix" id="querying-selected-shards-by-prefix" href="#querying-selected-shards-by-prefix">
...
<Admonition type="info" title="Prefixed sharding vs Anchoring documents" id="prefixed-sharding-vs-anchoring-documents" href="#prefixed-sharding-vs-anchoring-documents">
