...
<Admonition type="info" title="Database View" id="database-view" href="#database-view">
...
<Admonition type="info" title="Database Group" id="database-group" href="#database-group">
