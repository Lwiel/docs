...
<Admonition type="info" title="The Observer Log" id="the-observer-log" href="#the-observer-log">

![Figure 1. The Observer Log](./assets/cluster-observer-1.png)

</Admonition>

<Admonition type="info" title="Observer Log Data" id="observer-log-data" href="#observer-log-data">
