...
<Admonition type="info" title="Database Stats" id="database-stats" href="#database-stats">
...
<Admonition type="info" title="Database Actions" id="database-actions" href="#database-actions">
...
<Admonition type="info" title="Creating New Database Options" id="creating-new-database-options" href="#creating-new-database-options">
...
<Admonition type="info" title="More Actions" id="more-actions" href="#more-actions">
...
<Admonition type="info" title="Remote Database" id="remote-database" href="#remote-database">
