...
<Admonition type="info" title="The patch view" id="the-patch-view" href="#the-patch-view">
...
<Admonition type="info" title="The patch script" id="the-patch-script" href="#the-patch-script">
...
<Admonition type="info" title="Patch configuration" id="patch-configuration" href="#patch-configuration">
...
<Admonition type="info" title="Test patch" id="test-patch" href="#test-patch">
...
<Admonition type="info" title="Apply patch" id="apply-patch" href="#apply-patch">
