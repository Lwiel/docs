...
<Admonition type="info" title="Merge indexes" id="merge-indexes" href="#merge-indexes">
...
<Admonition type="info" title="Remove sub-indexes" id="remove-sub-indexes" href="#remove-sub-indexes">
...
<Admonition type="info" title="Remove unused indexes" id="remove-unused-indexes" href="#remove-unused-indexes">
...
<Admonition type="info" title="Indexes that will not be merged" id="indexes-that-will-not-be-merged" href="#indexes-that-will-not-be-merged">
...
<Admonition type="info" title="Merge suggestions errors" id="merge-suggestions-errors" href="#merge-suggestions-errors">
