...
<Admonition type="info" title="Create an OLAP ETL Task" id="create-an-olap-etl-task" href="#create-an-olap-etl-task">

To begin creating your OLAP ETL task:  

!["Ongoing tasks view"](./assets/ongoing-tasks-view.png)

!["Task selection view"](./assets/olap-etl-task-selection-view.png)

</Admonition>

<Admonition type="info" title="Define an OLAP ETL Task" id="define-an-olap-etl-task" href="#define-an-olap-etl-task">
...
!["Custom partition value"](./assets/olap-etl-2.png)
...
!["OLAP connection string"](./assets/olap-etl-4.png)
...
!["Override ID column"](./assets/olap-etl-8.png)
