...
<Admonition type="info" title="View Database Settings" id="view-database-settings" href="#view-database-settings">
...
<Admonition type="info" title="Edit Database Settings " id="edit-database-settings" href="#edit-database-settings">
...
<Admonition type="info" title="How to Reload the Database" id="how-to-reload-the-database" href="#how-to-reload-the-database">
