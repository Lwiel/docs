...
<Admonition type="info" title="Licensing a RavenDB docker image" id="licensing-a-ravendb-docker-image" href="#licensing-a-ravendb-docker-image">  
...
<Admonition type="info" title="Licensing RavenDB under Linux" id="licensing-ravendb-under-linux" href="#licensing-ravendb-under-linux">  
