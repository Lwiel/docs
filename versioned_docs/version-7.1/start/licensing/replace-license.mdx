...
<Admonition type="info" title="Replace license from Studio" id="replace-license-from-studio" href="#replace-license-from-studio">
...
<Admonition type="info" title="Maintain auto-renewal of Let's Encrypt certificates " id="maintain-auto-renewal-of-let-s-encrypt-certificates" href="#maintain-auto-renewal-of-let-s-encrypt-certificates">
...
<Admonition type="info" title="Upgrade a License Key For RavenDB 6.x" id="upgrade-a-license-key-for-ravendb-6-x" href="#upgrade-a-license-key-for-ravendb-6-x">
