...
<Admonition type="info" title="Create a Client Certificate with Read Only Access" id="create-a-client-certificate-with-read-only-access" href="#create-a-client-certificate-with-read-only-access">
...
<Admonition type="info" title="The Studio in Read Only Mode" id="the-studio-in-read-only-mode" href="#the-studio-in-read-only-mode">
