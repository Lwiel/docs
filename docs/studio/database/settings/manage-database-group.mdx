...
<Admonition type="info" title="Database Group Topology - View" id="database-group-topology-view" href="#database-group-topology-view">
...
<Admonition type="info" title="Database Group Topology - Actions" id="database-group-topology-actions" href="#database-group-topology-actions">
...
<Admonition type="info" title="Database Group Topology - Add New Node " id="database-group-topology-add-new-node" href="#database-group-topology-add-new-node">
...
<Admonition type="info" title="Database Group Topology - Members Duties " id="database-group-topology-members-duties" href="#database-group-topology-members-duties">
