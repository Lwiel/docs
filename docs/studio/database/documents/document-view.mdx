---
title: "Documents: Document View"
sidebar_label: Document View
sidebar_position: 0
---
...
<Admonition type="info" title="The Document View" id="the-document-view" href="#the-document-view">

![Figure 1. Document View](./assets/document-view-1.png)
...
<Admonition type="info" title="Document View - Actions" id="document-view-actions" href="#document-view-actions">

![Figure 2. Document View Actions](./assets/document-view-2.png)
