...
<Admonition type="info" title="Opening the All Revisions view" id="opening-the-all-revisions-view" href="#opening-the-all-revisions-view">
...
<Admonition type="info" title="Using the All Revisions view" id="using-the-all-revisions-view" href="#using-the-all-revisions-view">
...
<Admonition type="info" title="All ways to delete revisions" id="all-ways-to-delete-revisions" href="#all-ways-to-delete-revisions">
