...
<Admonition type="info" title="Backups View" id="backups-view" href="#backups-view">
...
<Admonition type="info" title="Periodic Backup Creation" id="periodic-backup-creation" href="#periodic-backup-creation">
...
<Admonition type="info" title="Manually Creating One-Time Backups" id="manually-creating-one-time-backups" href="#manually-creating-one-time-backups">
...
<Admonition type="info" title="Delaying a Running Backup Task" id="delaying-a-running-backup-task" href="#delaying-a-running-backup-task">
...
<Admonition type="info" title="When the Cluster or Node is Down" id="when-the-cluster-or-node-is-down" href="#when-the-cluster-or-node-is-down">
...
<Admonition type="info" title="Backup Task -vs- Replication Task" id="backup-task-vs-replication-task" href="#backup-task-vs-replication-task">
