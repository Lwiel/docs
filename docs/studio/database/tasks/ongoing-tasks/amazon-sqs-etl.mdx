---
title: "Studio: Amazon SQS ETL Task"
sidebar_label: Amazon SQS ETL Task
sidebar_position: 9
---
...
<Admonition type="info" title="Ongoing Tasks View" id="ongoing-tasks-view" href="#ongoing-tasks-view">

![Open the 'Add a Database Task' window](./assets/sqs_ongoing-tasks.png)
...
![Select the Task to Create](./assets/sqs_task-selection.png)
   
</Admonition>

<Admonition type="info" title="Define Amazon SQS ETL task" id="define-amazon-sqs-etl-task" href="#define-amazon-sqs-etl-task">

![Define Amazon SQS ETL Task](./assets/sqs_etl-define-task.png)
...
4. **Connection string and Authentication**  
    ...
    * `C.` **Advanced**  
      ...
      from the database after they are processed.  
         ...
         ![Delete processed documents](./assets/sqs_delete-processed-docs.png)
...
<Admonition type="info" title="Add or Edit Transformation Script" id="add-or-edit-transformation-script" href="#add-or-edit-transformation-script">

![Add or Edit Transform Script](./assets/sqs_etl_transformation-script.png)
...
<Admonition type="info" title="Comments" id="comments" href="#comments">
