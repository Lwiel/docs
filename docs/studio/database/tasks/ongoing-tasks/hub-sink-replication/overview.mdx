...
<Admonition type="info" title="What is Hub/Sink Replication for?" id="what-is-hub-sink-replication-for" href="#what-is-hub-sink-replication-for">
...
<Admonition type="info" title="What is and is not replicated?" id="what-is-and-is-not-replicated" href="#what-is-and-is-not-replicated">
...
<Admonition type="info" title="Accesses and Certificates" id="accesses-and-certificates" href="#accesses-and-certificates">
...
<Admonition type="info" title="Filtered Replication" id="filtered-replication" href="#filtered-replication">
...
<Admonition type="info" title="What does the replication include?" id="what-does-the-replication-include" href="#what-does-the-replication-include">
...
<Admonition type="info" title="Backward-Compatibility" id="backward-compatibility" href="#backward-compatibility">
