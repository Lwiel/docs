...
<Admonition type="info" title="Navigate to the Elasticsearch ETL Task View" id="navigate-to-the-elasticsearch-etl-task-view" href="#navigate-to-the-elasticsearch-etl-task-view">
...
<Admonition type="info" title="Define the Elasticsearch ETL Task" id="define-the-elasticsearch-etl-task" href="#define-the-elasticsearch-etl-task">
...
<Admonition type="info" title="Elasticsearch Indexes" id="elasticsearch-indexes" href="#elasticsearch-indexes">
