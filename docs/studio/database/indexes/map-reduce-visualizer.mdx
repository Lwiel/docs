...
<Admonition type="info" title="Map-Reduce Visualizer Usage Flow" id="map-reduce-visualizer-usage-flow" href="#map-reduce-visualizer-usage-flow">
...
<Admonition type="info" title="Map-Reduce Visualizer for Big Data" id="map-reduce-visualizer-for-big-data" href="#map-reduce-visualizer-for-big-data">
