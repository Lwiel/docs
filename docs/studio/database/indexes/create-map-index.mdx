...
<Admonition type="info" title="Edit Index View" id="edit-index-view" href="#edit-index-view">
...
<Admonition type="info" title="Test Index" id="test-index" href="#test-index">
...
<Admonition type="info" title="Index Fields & Terms" id="index-fields-terms" href="#index-fields-terms">
...
<Admonition type="info" title="Index Field Options" id="index-field-options" href="#index-field-options">
...
![Add Compound Field](./assets/create-map-index_add-compound-field-2.png)
...
<Admonition type="info" title="Configuration" id="configuration" href="#configuration">
...
<Admonition type="info" title="Additional Assemblies" id="additional-assemblies" href="#additional-assemblies">
...
<Admonition type="info" title="Additional Sources" id="additional-sources" href="#additional-sources">
...
<Admonition type="info" title="Spatial Field Options" id="spatial-field-options" href="#spatial-field-options">
