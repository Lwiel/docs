...
<Admonition type="info" title="The Map Stage" id="the-map-stage" href="#the-map-stage">
...
<Admonition type="info" title="The Reduce Stage" id="the-reduce-stage" href="#the-reduce-stage">
...
<Admonition type="info" title="Important Guidelines" id="important-guidelines" href="#important-guidelines">
...
<Admonition type="info" title="Map-Reduce Query Results" id="map-reduce-query-results" href="#map-reduce-query-results">
...
<Admonition type="info" title="Multi-Map-Reduce" id="multi-map-reduce" href="#multi-map-reduce">
...
<Admonition type="info" title="Saving Map-Reduce Results in a Collection (Artificial Documents)" id="saving-map-reduce-results-in-a-collection-artificial-documents" href="#saving-map-reduce-results-in-a-collection-artificial-documents">
