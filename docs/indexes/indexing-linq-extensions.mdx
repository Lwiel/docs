...
<Admonition type="info" title="**Boost**" id="boost" href="#boost">

You can read more about boosting [here](../indexes/boosting).

</Admonition>

<Admonition type="info" title="**Reverse**" id="reverse" href="#reverse">
...
<Admonition type="info" title="**WhereEntityIs**" id="whereentityis" href="#whereentityis">
...
<Admonition type="info" title="**IfEntityIs**" id="ifentityis" href="#ifentityis">

`IfEntityIs` is similar to `WhereEntityIs`, yet it checks only against one value.

</Admonition>

<Admonition type="info" title="**Parsing numbers**" id="parsing-numbers" href="#parsing-numbers">
