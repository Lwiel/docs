...
<Admonition type="info" title="`RavenTestDriver`" id="raventestdriver" href="#raventestdriver">
...
<Admonition type="info" title="Pre-initializing the store: `PreInitialize`" id="pre-initializing-the-store-preinitialize" href="#pre-initializing-the-store-preinitialize">

Pre-Initializing the IDocumentStore allows you to mutate the conventions used by the document store.

### Example

<TabItem value="something" label="test_driver_PreInitialize">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Configure the server: `ConfigureServer`" id="configure-the-server-configureserver" href="#configure-the-server-configureserver">
...
<TabItem value="something" label="test_driver_ConfigureServer">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Unit test" id="unit-test" href="#unit-test">
...
<TabItem value="something" label="test_driver_MyFirstTest">
<CodeBlock language="csharp">
{`[Fact]
...
<Admonition type="info" title="Complete example" id="complete-example" href="#complete-example">
...
<TabItem value="something" label="test_full_example">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Continuous Integration (CI) Servers" id="continuous-integration-ci-servers" href="#continuous-integration-ci-servers">
...
<Admonition type="info" title="Licensing" id="licensing" href="#licensing">
...
<Admonition type="info" title="PreInitialize" id="preinitialize" href="#preinitialize">

Pre-Initializing the IDocumentStore allows you to mutate the conventions used by the document store.

### Example

<TabItem value="something-something" label="test_driver_PreInitialize">
...
<Admonition type="info" title="UnitTest" id="unittest" href="#unittest">
...
<TabItem value="something-something" label="test_driver_MyFirstTest">
<CodeBlock language="java">
{`@Test
public void myFirstTest() \{
...
<Admonition type="info" title="ConfigureServer" id="configureserver" href="#configureserver">
...
<TabItem value="something-something" label="test_driver_ConfigureServer">
<CodeBlock language="java">
...
<TabItem value="something-something" label="test_full_example">
<CodeBlock language="java">
