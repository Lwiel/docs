...
<Admonition type="info" title="Before We Get Started" id="before-we-get-started" href="#before-we-get-started">
...
<Admonition type="info" title="Create a Local Azure Function App" id="create-a-local-azure-function-app" href="#create-a-local-azure-function-app">
...
<Admonition type="info" title="Configuring Local Connection to RavenDB" id="configuring-local-connection-to-ravendb" href="#configuring-local-connection-to-ravendb">
...
<Admonition type="info" title="Creating Function App Resources in Azure" id="creating-function-app-resources-in-azure" href="#creating-function-app-resources-in-azure">
...
<Admonition type="info" title="Deploying to Azure" id="deploying-to-azure" href="#deploying-to-azure">
...
<Admonition type="info" title="Verify the Connection Works" id="verify-the-connection-works" href="#verify-the-connection-works">
...
<Admonition type="info" title="Using RavenDB in the Azure Functions App" id="using-ravendb-in-the-azure-functions-app" href="#using-ravendb-in-the-azure-functions-app">
...
<TabItem value="something" label="HttpTrigger1">
...
<TabItem value="something" label="HttpTrigger2">
<CodeBlock language="csharp">
{`private readonly IAsyncDocumentSession session;
...
<Admonition type="info" title="Tutorial Video" id="tutorial-video" href="#tutorial-video">
...
# Guides: Azure Functions (Node.js)
---
...
<Admonition type="info" title="Connecting to RavenDB" id="connecting-to-ravendb" href="#connecting-to-ravendb">
...
<Admonition type="info" title="Creating a Function App in Azure" id="creating-a-function-app-in-azure" href="#creating-a-function-app-in-azure">
