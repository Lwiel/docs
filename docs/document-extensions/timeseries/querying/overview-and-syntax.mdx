...
<Admonition type="info" title="Time series query capabilities" id="time-series-query-capabilities" href="#time-series-query-capabilities">
...
<Admonition type="info" title="Server and client queries" id="server-and-client-queries" href="#server-and-client-queries">
...
<Admonition type="info" title="Dynamic and index queries" id="dynamic-and-index-queries" href="#dynamic-and-index-queries">
...
<Admonition type="info" title="Scaling query results" id="scaling-query-results" href="#scaling-query-results">
...
<Admonition type="info" title="RQL syntax" id="rql-syntax" href="#rql-syntax">
...
<Admonition type="info" title="Combine time series and custom functions" id="combine-time-series-and-custom-functions" href="#combine-time-series-and-custom-functions">
...
<TabItem value="something" label="DefineCustomFunctions_ModifiedTimeSeriesEntry">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Use Studio to experiment" id="use-studio-to-experiment" href="#use-studio-to-experiment">
...
<TabItem value="something-something" label="DefineCustomFunctions_ModifiedTimeSeriesEntry">
<CodeBlock language="python">
