...
<Admonition type="info" title="Include time series when making a query" id="include-time-series-when-making-a-query" href="#include-time-series-when-making-a-query">
