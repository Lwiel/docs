...
<Admonition type="info" title="`Append` usage" id="append-usage" href="#append-usage">
...
<TabItem value="something" label="timeseries_region_TimeSeriesFor-Append-TimeSeries-Range">
...
<TabItem value="something" label="TimeSeriesFor-Append-definition-double">
<CodeBlock language="csharp">
...
<TabItem value="something" label="TimeSeriesFor-Append-definition-inum">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="timeseries_region_TimeSeriesFor-Append-TimeSeries-Range">
...
<TabItem value="something-something" label="TimeSeriesFor-Append-definition-double">
<CodeBlock language="python">
...
<TabItem value="something-something" label="TimeSeriesFor-Append-definition-inum">
<CodeBlock language="python">
