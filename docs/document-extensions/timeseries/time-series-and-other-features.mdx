...
<Admonition type="info" title="General features" id="general-features" href="#general-features">  
...
<Admonition type="info" title="Smuggler" id="smuggler" href="#smuggler">
...
<Admonition type="info" title="Ongoing tasks" id="ongoing-tasks" href="#ongoing-tasks">
