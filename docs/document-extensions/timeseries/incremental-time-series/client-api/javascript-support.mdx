...
<Admonition type="info" title="The `timeseries` Interface" id="the-timeseries-interface" href="#the-timeseries-interface">
...
<Admonition type="info" title="`timeseries.increment`" id="timeseries-increment" href="#timeseries-increment">
...
<Admonition type="info" title="Usage Sample" id="usage-sample" href="#usage-sample">
...
<TabItem value="something" label="incremental_PatchIncrementalTimeSeries">
<CodeBlock language="csharp">
