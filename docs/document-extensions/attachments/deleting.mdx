...
<TabItem value="something" label="DeleteSyntax">
...
<TabItem value="something-something" label="DeleteSyntax">
...
<TabItem value="something-something" label="DeleteAttachment">
<CodeBlock language="java">
