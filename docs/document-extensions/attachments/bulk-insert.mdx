...
<Admonition type="info" title="Usage example" id="usage-example" href="#usage-example">
...
<TabItem value="something" label="AttachmentsFor-definition">
<CodeBlock language="csharp">
...
<TabItem value="something" label="AttachmentsFor.Store-definition">
<CodeBlock language="csharp">
...
In this example, we attach a file to all User documents that match a query.  
<TabItem value="something-something" label="bulk_insert_attachment">
