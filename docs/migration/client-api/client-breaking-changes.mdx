...
<Admonition type="info" title="Subscription creation overload modification" id="subscription-creation-overload-modification" href="#subscription-creation-overload-modification">
...
<Admonition type="info" title="HTTP-Compression algorithm is now `Zstd` by default" id="http-compression-algorithm-is-now-zstd-by-default" href="#http-compression-algorithm-is-now-zstd-by-default">
...
<TabItem value="something" label="SwitchCompressionAlgorithm">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Bulk-insert Compression is now Enabled by default" id="bulk-insert-compression-is-now-enabled-by-default" href="#bulk-insert-compression-is-now-enabled-by-default">
...
<TabItem value="something" label="switchBulkInsertState">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Removed irrelevant `SingleNodeBatchCommand` parameters" id="removed-irrelevant-singlenodebatchcommand-parameters" href="#removed-irrelevant-singlenodebatchcommand-parameters">
...
<Admonition type="info" title="Removed obsolete methods" id="removed-obsolete-methods" href="#removed-obsolete-methods">
...
<Admonition type="info" title="`FromEtl` is now internal" id="frometl-is-now-internal" href="#frometl-is-now-internal">
