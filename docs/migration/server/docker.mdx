...
<Admonition type="info" title="Changes Made In RavenDB 6.0 And Up" id="changes-made-in-ravendb-6-0-and-up" href="#changes-made-in-ravendb-6-0-and-up">  
...
<Admonition type="info" title="Migrating To `6.0` And Up" id="migrating-to-6-0-and-up" href="#migrating-to-6-0-and-up">  
