...
<Admonition type="info" title="RavenDB incorporates NLog as its logging system" id="ravendb-incorporates-nlog-as-its-logging-system" href="#ravendb-incorporates-nlog-as-its-logging-system">
...
<Admonition type="info" title="Removed obsolete properties" id="removed-obsolete-properties" href="#removed-obsolete-properties">
