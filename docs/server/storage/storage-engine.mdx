...
<Admonition type="info" title="Transaction support" id="transaction-support" href="#transaction-support">
...
<Admonition type="info" title="Single write model" id="single-write-model" href="#single-write-model">
...
<Admonition type="info" title="Memory-mapped files" id="memory-mapped-files" href="#memory-mapped-files">
...
<Admonition type="info" title="Requirements" id="requirements" href="#requirements">
...
<Admonition type="info" title="Limitations" id="limitations" href="#limitations">
