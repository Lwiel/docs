...
<Admonition type="info" title="Providing a Master Key to RavenDB" id="providing-a-master-key-to-ravendb" href="#providing-a-master-key-to-ravendb">
...
<Admonition type="info" title="Relying on the OS Protection Methods" id="relying-on-the-os-protection-methods" href="#relying-on-the-os-protection-methods">
