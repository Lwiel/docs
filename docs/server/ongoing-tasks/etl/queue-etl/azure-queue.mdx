...
<TabItem value="something" label="add_azure_connection_string">
...
<TabItem value="something" label="azure_con_str_settings">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Add an Azure Queue Storage ETL task" id="add-an-azure-queue-storage-etl-task" href="#add-an-azure-queue-storage-etl-task">
...
<TabItem value="something" label="add_azure_etl_task">
<CodeBlock language="csharp">
...
<TabItem value="something" label="azure_delete_documents">
<CodeBlock language="csharp">
{`var etlTask = new QueueEtlConfiguration()
\{
    BrokerType = QueueBrokerType.AzureQueueStorage,
