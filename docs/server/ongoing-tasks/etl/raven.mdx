...
<Admonition type="info" title="Transformation Script Options" id="transformation-script-options" href="#transformation-script-options">
...
<Admonition type="info" title="Empty Script" id="empty-script" href="#empty-script">
...
<Admonition type="info" title="Attachments" id="attachments" href="#attachments">
...
<Admonition type="info" title="Counters" id="counters" href="#counters">
...
<Admonition type="info" title="Time Series" id="time-series" href="#time-series">
...
<Admonition type="info" title="Deletions" id="deletions" href="#deletions">
