...
<Admonition type="info" title="`rvn`" id="rvn" href="#rvn">
...
<Admonition type="info" title="`stats`" id="stats" href="#stats">
...
<Admonition type="info" title="`log`" id="log" href="#log">
...
<Admonition type="note" title="Examples" id="examples" href="#examples">
...
<Admonition type="info" title="`gc`" id="gc" href="#gc">
...
<Admonition type="info" title="`shutdown | q`" id="shutdown-q" href="#shutdown-q">
...
<Admonition type="info" title="`restartServer`, `resetServer`" id="restartserver-resetserver" href="#restartserver-resetserver">
...
<Admonition type="info" title="`script`" id="script" href="#script">
...
<Admonition type="info" title="`generateClientCert`" id="generateclientcert" href="#generateclientcert">
...
<Admonition type="info" title="`trustServerCert`" id="trustservercert" href="#trustservercert">
...
<Admonition type="info" title="`trustClientCert`" id="trustclientcert" href="#trustclientcert">
...
<Admonition type="info" title="`replaceClusterCert`" id="replaceclustercert" href="#replaceclustercert">
...
<Admonition type="info" title="`clear`" id="clear" href="#clear">
...
<Admonition type="info" title="`prompt`" id="prompt" href="#prompt">
...
<Admonition type="info" title="`logout`" id="logout" href="#logout">
...
<Admonition type="info" title="`logo`" id="logo" href="#logo">
...
<Admonition type="info" title="`help`" id="help" href="#help">
...
<Admonition type="info" title="`lowMem`" id="lowmem" href="#lowmem">
...
<Admonition type="info" title="`timer`" id="timer" href="#timer">
