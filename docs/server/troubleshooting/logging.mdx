...
<Admonition type="info" title="Available logging destinations" id="available-logging-destinations" href="#available-logging-destinations">
...
<Admonition type="info" title="Logging configuration" id="logging-configuration" href="#logging-configuration">
...
<Admonition type="info" title="Available logging levels" id="available-logging-levels" href="#available-logging-levels">
...
<Admonition type="info" title="Default values" id="default-values" href="#default-values">
...
<Admonition type="info" title="CLI customization: immediate temporary changes" id="cli-customization-immediate-temporary-changes" href="#cli-customization-immediate-temporary-changes">
...
<Admonition type="info" title="Configuring and using NLog" id="configuring-and-using-nlog" href="#configuring-and-using-nlog">
...
<Admonition type="info" title="Studio: Admin Logs" id="studio-admin-logs" href="#studio-admin-logs">
