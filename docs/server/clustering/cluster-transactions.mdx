...
<Admonition type="info" title="Why Cluster-Wide Transactions" id="why-cluster-wide-transactions" href="#why-cluster-wide-transactions">
...
<Admonition type="info" title="How Cluster Transactions Work" id="how-cluster-transactions-work" href="#how-cluster-transactions-work">
...
<Admonition type="info" title="Cluster Transactions Properties" id="cluster-transactions-properties" href="#cluster-transactions-properties">
...
<Admonition type="info" title="Concurrent Cluster-Wide and Single-Node Transactions" id="concurrent-cluster-wide-and-single-node-transactions" href="#concurrent-cluster-wide-and-single-node-transactions">
...
<Admonition type="info" title="Failure Modes in Cluster-Wide Transactions" id="failure-modes-in-cluster-wide-transactions" href="#failure-modes-in-cluster-wide-transactions">
...
<Admonition type="info" title="Debug Cluster-Wide Transactions" id="debug-cluster-wide-transactions" href="#debug-cluster-wide-transactions">
