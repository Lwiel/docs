...
<Admonition type="info" title="What are Change Vectors Constructed From?" id="what-are-change-vectors-constructed-from" href="#what-are-change-vectors-constructed-from">
...
<Admonition type="info" title="How are Change Vectors used to Determine Order?" id="how-are-change-vectors-used-to-determine-order" href="#how-are-change-vectors-used-to-determine-order">
...
<Admonition type="info" title="Concurrency Control & Change Vectors" id="concurrency-control-change-vectors" href="#concurrency-control-change-vectors">
...
<Admonition type="info" title="Change Vector Comparisons" id="change-vector-comparisons" href="#change-vector-comparisons">
...
<Admonition type="info" title="Concurrency Control at the Cluster" id="concurrency-control-at-the-cluster" href="#concurrency-control-at-the-cluster">
...
<Admonition type="info" title="Database Global Change Vector" id="database-global-change-vector" href="#database-global-change-vector">
...
<Admonition type="info" title="After Restoring a Database from Backup" id="after-restoring-a-database-from-backup" href="#after-restoring-a-database-from-backup">
