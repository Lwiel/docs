...
<Admonition type="info" title="Prerequisite" id="prerequisite" href="#prerequisite">
...
<Admonition type="info" title="Installation" id="installation" href="#installation">
...
<Admonition type="info" title="Starting the Server" id="starting-the-server" href="#starting-the-server">

RavenDB Embedded Server is available under `EmbeddedServer.Instance`.  
In order to start it, call `StartServer` method.

<TabItem value="something" label="start_server">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Server Options" id="server-options" href="#server-options">
...
<TabItem value="something" label="start_server_with_options">
<CodeBlock language="csharp">
...
<TabItem value="something" label="start_server_with_server_directory_option">
<CodeBlock language="csharp">
{`EmbeddedServer.Instance.StartServer(new ServerOptions
\{
...
<TabItem value="something" label="restart_server">
<CodeBlock language="csharp">
...
<Admonition type="info" title=".NET FrameworkVersion" id="net-frameworkversion" href="#net-frameworkversion">
...
<TabItem value="something" label="start_server_with_FrameworkVersion_defined">
<CodeBlock language="csharp">
{`EmbeddedServer.Instance.StartServer(new ServerOptions
\{
...
<Admonition type="info" title="Security" id="security" href="#security">
...
<TabItem value="something" label="security">
<CodeBlock language="csharp">
...
<TabItem value="something" label="security2">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Document Store" id="document-store" href="#document-store">
...
<Admonition type="info" title="Get Server URL and Process ID" id="get-server-url-and-process-id" href="#get-server-url-and-process-id">
...
<TabItem value="something" label="get_server_url_async">
<CodeBlock language="csharp">
...
<TabItem value="something" label="get_server_process_id">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="embedded_example">
...
<Admonition type="info" title="Getting Started" id="getting-started" href="#getting-started">
...
<TabItem value="something-something" label="start_server">
<CodeBlock language="java">
{`// Start RavenDB Embedded Server with default options
EmbeddedServer.INSTANCE.startServer();
`}
...
<TabItem value="something-something" label="start_server_with_options">
<CodeBlock language="java">
...
<TabItem value="something-something" label="security">
<CodeBlock language="java">
{`ServerOptions serverOptions = new ServerOptions();
...
<TabItem value="something-something" label="security2">
<CodeBlock language="java">
{`ServerOptions serverOptions = new ServerOptions();
...
<TabItem value="something-something" label="get_document_store">
<CodeBlock language="java">
{`EmbeddedServer.INSTANCE.getDocumentStore("Embedded");
`}
</CodeBlock>
...
<TabItem value="something-something" label="get_document_store_with_database_options">
<CodeBlock language="java">
...
<TabItem value="something-something" label="get_server_url">
<CodeBlock language="java">
