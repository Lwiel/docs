...
<Admonition type="info" title="Put custom sorter server-wide" id="put-custom-sorter-server-wide" href="#put-custom-sorter-server-wide">
...
<TabItem value="something-something" label="put_sorter">
