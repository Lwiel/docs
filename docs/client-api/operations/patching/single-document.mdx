...
<Admonition type="info" title="Session API" id="session-api" href="#session-api">
...
<TabItem value="something" label="patch_generic_interface_increment">
...
<TabItem value="something" label="add_or_increment_generic">
<CodeBlock language="csharp">
...
<TabItem value="something" label="patch_generic_interface_set_value">
<CodeBlock language="csharp">
...
<TabItem value="something" label="add_or_patch_generic">
<CodeBlock language="csharp">
...
`Session.Advanced.Patch`
<TabItem value="something" label="patch_generic_interface_array_modification_lambda">
<CodeBlock language="csharp">
...
`Session.Advanced.AddOrPatch`
<TabItem value="something" label="add_or_patch_array_generic">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Session API using Defer" id="session-api-using-defer" href="#session-api-using-defer">
...
<TabItem value="something" label="patch_non_generic_interface_in_session">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Operations API" id="operations-api" href="#operations-api">
...
<TabItem value="something" label="patch_non_generic_interface_in_store">
<CodeBlock language="csharp">
...
<Admonition type="info" title="List of script methods" id="list-of-script-methods" href="#list-of-script-methods">
...
<TabItem value="something" label="Add_Or_Increment_Sample">
<CodeBlock language="csharp">
...
<TabItem value="something" label="Add_Or_Patch_Sample">
<CodeBlock language="csharp">
...
<TabItem value="something" label="Add_Or_Patch_Array_Sample">
<CodeBlock language="csharp">
{`// While running AddOrPatch specify <entity type, field type>
session.Advanced.AddOrPatch<User, DateTime>(
...
### Increment Field Value
`session.advanced().increment`
<TabItem value="something-something" label="patch_generic_interface_increment">
...
### Set Field Value
`session.advanced().patch`
<TabItem value="something-something" label="patch_generic_interface_set_value">
<CodeBlock language="java">
...
### Array Manipulation
`session.advanced().patch`
<TabItem value="something-something" label="patch_generic_interface_array_modification_lambda">
<CodeBlock language="java">
...
`session.advanced().defer`
<TabItem value="something-something" label="patch_non_generic_interface_in_session">
<CodeBlock language="java">
{`void defer(ICommandData[] commands);
`}
</CodeBlock>
...
<TabItem value="something-something" label="patch_non_generic_interface_in_store">
<CodeBlock language="java">
{`PatchStatus send(PatchOperation operation);
...
<Admonition type="info" title="API overview" id="api-overview" href="#api-overview">
...
<TabItem value="something-something" label="patch_syntax">
<CodeBlock language="nodejs">
{`patch(id, path, value);
...
<TabItem value="something-something" label="add_or_patch_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="increment_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="add_or_increment_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="patch_array_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="add_or_patch_array_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="class_JavaScriptArray">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="defer_syntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="class_PatchCommandData">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="class_PatchRequest">
<CodeBlock language="nodejs">
{`class PatchRequest \{
...
<TabItem value="something-something" label="operations_syntax">
<CodeBlock language="nodejs">
