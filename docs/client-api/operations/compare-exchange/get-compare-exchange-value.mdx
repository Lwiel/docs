...
<Admonition type="info" title="Example I - Value is 'long'" id="example-i-value-is-long" href="#example-i-value-is-long"> 
...
<Admonition type="info" title="Example II - Value is a custom object" id="example-ii-value-is-a-custom-object" href="#example-ii-value-is-a-custom-object"> 
