...
<Admonition type="info" title="Example I - Get Values for Specified Keys" id="example-i-get-values-for-specified-keys" href="#example-i-get-values-for-specified-keys">
...
<Admonition type="info" title="Example II - Get Values for Keys with Common Prefix" id="example-ii-get-values-for-keys-with-common-prefix" href="#example-ii-get-values-for-keys-with-common-prefix">
