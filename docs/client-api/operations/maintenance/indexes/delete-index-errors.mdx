...
<Admonition type="info" title="Delete errors from all indexes" id="delete-errors-from-all-indexes" href="#delete-errors-from-all-indexes">
...
<Admonition type="info" title="Delete errors from specific indexes" id="delete-errors-from-specific-indexes" href="#delete-errors-from-specific-indexes">
