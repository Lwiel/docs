...
<Admonition type="info" title="Get index names example" id="get-index-names-example" href="#get-index-names-example">
...
<TabItem value="something" label="get_index_names_syntax">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="get_3_0">
...
<TabItem value="something-something" label="get_3_1">
<CodeBlock language="java">
{`String[] indexNames
    = store.maintenance()
...
<TabItem value="something-something" label="get_index_names">
...
<TabItem value="something-something" label="get_index_names_syntax">
<CodeBlock language="python">
