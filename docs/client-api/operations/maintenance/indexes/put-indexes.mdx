...
<Admonition type="info" title="Ways to deploy indexes - short summary " id="ways-to-deploy-indexes-short-summary" href="#ways-to-deploy-indexes-short-summary">
...
<Admonition type="info" title="Put indexes operation with IndexDefinition " id="put-indexes-operation-with-indexdefinition" href="#put-indexes-operation-with-indexdefinition">
...
<Admonition type="info" title="Put indexes operation with IndexDefinitionBuilder " id="put-indexes-operation-with-indexdefinitionbuilder" href="#put-indexes-operation-with-indexdefinitionbuilder">
