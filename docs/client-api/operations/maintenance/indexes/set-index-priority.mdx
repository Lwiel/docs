...
<Admonition type="info" title="Index priority" id="index-priority" href="#index-priority">
...
<Admonition type="info" title="Set priority - single index" id="set-priority-single-index" href="#set-priority-single-index">
...
<Admonition type="info" title="Set priority - multiple indexes" id="set-priority-multiple-indexes" href="#set-priority-multiple-indexes">
