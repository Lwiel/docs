...
<Admonition type="info" title="Server maintenance operations - ForNode" id="server-maintenance-operations-fornode" href="#server-maintenance-operations-fornode">
...
<TabItem value="something" label="for_node_1">
...
<TabItem value="something-something" label="for_node_1">
