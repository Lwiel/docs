...
<Admonition type="info" title="Common operation: `Operations.ForDatabase`" id="common-operation-operations-fordatabase" href="#common-operation-operations-fordatabase">

* For reference, all common operations are listed [here](../../../client-api/operations/what-are-operations#common-operations).

<TabItem value="something" label="for_database_1">
...
<Admonition type="info" title="Maintenance operation: `Maintenance.ForDatabase`" id="maintenance-operation-maintenance-fordatabase" href="#maintenance-operation-maintenance-fordatabase">
...
<TabItem value="something" label="for_database_2">
<CodeBlock language="csharp">
{`// Define default database on the store
var documentStore = new DocumentStore
\{
...
<Admonition type="info" title="Operations.forDatabase" id="operations-fordatabase" href="#operations-fordatabase">

<TabItem value="something-something" label="for_database_1">
...
<TabItem value="something-something" label="for_database_3">
<CodeBlock language="java">
...
<Admonition type="info" title="Maintenance.forDatabase" id="maintenance-fordatabase" href="#maintenance-fordatabase">

<TabItem value="something-something" label="for_database_2">
<CodeBlock language="java">
{`MaintenanceOperationExecutor forDatabase(String databaseName);
`}
</CodeBlock>
...
<TabItem value="something-something" label="for_database_4">
<CodeBlock language="java">
...
<Admonition type="info" title="Common operation: `operations.for_database`" id="common-operation-operations-for_database" href="#common-operation-operations-for_database">
...
<Admonition type="info" title="Maintenance operation: `maintenance.for_database`" id="maintenance-operation-maintenance-for_database" href="#maintenance-operation-maintenance-for_database">
...
<Admonition type="info" title="Common operation: `forDatabase`" id="common-operation-fordatabase" href="#common-operation-fordatabase">
