...
<Admonition type="info" title="Collection Name Generation" id="collection-name-generation" href="#collection-name-generation">
...
<Admonition type="info" title="Collection Usages" id="collection-usages" href="#collection-usages">
