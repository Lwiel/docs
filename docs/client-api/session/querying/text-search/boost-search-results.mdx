...
<Admonition type="info" title="Boost results - when making a full-text search" id="boost-results-when-making-a-full-text-search" href="#boost-results-when-making-a-full-text-search">
...
<Admonition type="info" title="Boost results - when querying with where clause" id="boost-results-when-querying-with-where-clause" href="#boost-results-when-querying-with-where-clause">
