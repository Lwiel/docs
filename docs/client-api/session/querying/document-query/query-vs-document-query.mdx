...
<Admonition type="info" title="API support" id="api-support" href="#api-support">
...
<Admonition type="info" title="Immutability" id="immutability" href="#immutability">
...
<Admonition type="info" title="Default Query Operator" id="default-query-operator" href="#default-query-operator">
...
<Admonition type="info" title="Mutability" id="mutability" href="#mutability">
...
<Admonition type="info" title="`query `and `documentQuery` equivalents" id="query-and-documentquery-equivalents" href="#query-and-documentquery-equivalents">
