...
<Admonition type="info" title="Query the collection (dynamic query)" id="query-the-collection-dynamic-query" href="#query-the-collection-dynamic-query">
...
<Admonition type="info" title="Query a static index" id="query-a-static-index" href="#query-a-static-index">
...
<Admonition type="info" title="Use Studio to Run an RQL Query" id="use-studio-to-run-an-rql-query" href="#use-studio-to-run-an-rql-query">
