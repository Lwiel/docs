...
<Admonition type="info" title="Group By Single Field" id="group-by-single-field" href="#group-by-single-field">
...
<Admonition type="info" title="Group By Multiple Fields" id="group-by-multiple-fields" href="#group-by-multiple-fields">
...
<Admonition type="info" title="Select Composite GroupBy Key" id="select-composite-groupby-key" href="#select-composite-groupby-key">
...
<Admonition type="info" title="Group By Array" id="group-by-array" href="#group-by-array">
...
<TabItem value="something" label="group_by_using">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Sorting" id="sorting" href="#sorting">
...
<TabItem value="something-something" label="group_by_using">
<CodeBlock language="java">
...
<Admonition type="info" title="Group By a Single Field" id="group-by-a-single-field" href="#group-by-a-single-field">
