...
<Admonition type="info" title="Enable for specific session" id="enable-for-specific-session" href="#enable-for-specific-session">
...
<Admonition type="info" title="Enable globally" id="enable-globally" href="#enable-globally">
...
<Admonition type="info" title="Disable for specific document (when enabled on session)" id="disable-for-specific-document-when-enabled-on-session" href="#disable-for-specific-document-when-enabled-on-session">
...
<Admonition type="info" title="Enable for specific document (when disabled on session)" id="enable-for-specific-document-when-disabled-on-session" href="#enable-for-specific-document-when-disabled-on-session">
