...
<Admonition type="info" title="Disable tracking changes for a specific entity" id="disable-tracking-changes-for-a-specific-entity" href="#disable-tracking-changes-for-a-specific-entity">
...
<Admonition type="info" title="Disable tracking all entities in session" id="disable-tracking-all-entities-in-session" href="#disable-tracking-all-entities-in-session">
...
<Admonition type="info" title="Disable tracking query results" id="disable-tracking-query-results" href="#disable-tracking-query-results">
...
<Admonition type="info" title="Customize tracking in conventions" id="customize-tracking-in-conventions" href="#customize-tracking-in-conventions">
...
<TabItem value="something-something" label="disable_tracking_4">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Using 'Include' in a NoTracking session will throw" id="using-include-in-a-notracking-session-will-throw" href="#using-include-in-a-notracking-session-will-throw">
...
<TabItem value="something-something" label="disable_tracking_1">
...
<Admonition type="info" title="Disable tracking for all entities in a session" id="disable-tracking-for-all-entities-in-a-session" href="#disable-tracking-for-all-entities-in-a-session">
...
<TabItem value="something-something" label="disable_tracking_2">
<CodeBlock language="python">
...
<Admonition type="info" title="Disable tracking for query results" id="disable-tracking-for-query-results" href="#disable-tracking-for-query-results">
...
<TabItem value="something-something" label="disable_tracking_3">
<CodeBlock language="nodejs">
{`const session = documentStore.openSession();
...
<TabItem value="something-something" label="disable_tracking_5">
<CodeBlock language="nodejs">
{`const session = documentStore.openSession(\{
    // Working with a non-tracking session
    noTracking: true
...
<TabItem value="something-something" label="disable_tracking_6">
<CodeBlock language="nodejs">
{`const session = documentStore.openSession(\{
    // Working with a non-tracking session
    noTracking: true
