...
<Admonition type="info" title="Check for entity changes " id="check-for-entity-changes" href="#check-for-entity-changes">
...
<Admonition type="info" title="Get entity changes " id="get-entity-changes" href="#get-entity-changes">
