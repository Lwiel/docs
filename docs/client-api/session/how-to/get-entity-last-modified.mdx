...
<TabItem value="something" label="get_last_modified_1">
...
<TabItem value="something" label="get_last_modified_2">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="get_last_modified_1">
...
<TabItem value="something-something" label="get_last_modified_2">
<CodeBlock language="java">
