...
---
<Admonition type="info" title="Example - Without a Default Database" id="example-without-a-default-database" href="#example-without-a-default-database">

<TabItem value="something" label="default_database_1">
...
<Admonition type="info" title="Example - With a Default Database" id="example-with-a-default-database" href="#example-with-a-default-database">

The default database is defined in the Document Store's `Database` property.
<TabItem value="something" label="default_database_2">
<CodeBlock language="csharp">
{`using (IDocumentStore store = new DocumentStore
\{
    Urls = new[] \{ "http://your_RavenDB_server_URL" \},
...
<TabItem value="something-something" label="default_database_1">
...
<TabItem value="something-something" label="default_database_2">
<CodeBlock language="java">
