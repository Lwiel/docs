...
<Admonition type="info" title="DocumentSubscriptions class" id="documentsubscriptions-class" href="#documentsubscriptions-class">
...
<Admonition type="info" title="Delete subscription" id="delete-subscription" href="#delete-subscription">
...
<Admonition type="info" title="Disable subscription" id="disable-subscription" href="#disable-subscription">
...
<Admonition type="info" title="Enable subscription" id="enable-subscription" href="#enable-subscription">
...
<Admonition type="info" title="Update subscription" id="update-subscription" href="#update-subscription">
...
<Admonition type="info" title="Drop connection" id="drop-connection" href="#drop-connection">
...
<Admonition type="info" title="Get subscription state" id="get-subscription-state" href="#get-subscription-state">
...
<Admonition type="info" title="Deleting subscription" id="deleting-subscription" href="#deleting-subscription">
...
<Admonition type="info" title="Dropping connection" id="dropping-connection" href="#dropping-connection">
...
<Admonition type="info" title="Disabling subscription" id="disabling-subscription" href="#disabling-subscription">
...
<Admonition type="info" title="Updating subscription" id="updating-subscription" href="#updating-subscription">
...
<Admonition type="info" title="Getting subscription status" id="getting-subscription-status" href="#getting-subscription-status">
...
<Admonition type="info" title="Get subscriptions" id="get-subscriptions" href="#get-subscriptions">
