...
<Admonition type="info" title="Subscription creation" id="subscription-creation" href="#subscription-creation">
...
<TabItem value="something" label="create_whole_collection_generic1">
...
<Admonition type="info" title="Subscription name" id="subscription-name" href="#subscription-name">
...
<TabItem value="something" label="create_whole_collection_generic_with_name">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Responsible node" id="responsible-node" href="#responsible-node">
...
<TabItem value="something" label="create_whole_collection_generic_with_mentor_node">
<CodeBlock language="csharp">
...
<TabItem value="something-something" label="create_whole_collection_generic1">
...
<TabItem value="something-something" label="create_whole_collection_generic_with_name">
<CodeBlock language="java">
...
<TabItem value="something-something" label="create_whole_collection_generic_with_mentor_node">
<CodeBlock language="java">
{`SubscriptionCreationOptions options = new SubscriptionCreationOptions();
