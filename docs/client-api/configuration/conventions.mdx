...
<Admonition type="info" title="How to set conventions" id="how-to-set-conventions" href="#how-to-set-conventions">
...
<TabItem value="something" label="conventions_1">
...
<Admonition type="info" title="Conventions:" id="conventions" href="#conventions">
...
<TabItem value="something" label="AddIdFieldToDynamicObjectsSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="AggressiveCacheDurationSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="AggressiveCacheModeSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="AsyncDocumentIdGenerator">
<CodeBlock language="csharp">
...
<TabItem value="something" label="AsyncDocumentIdGeneratorSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="CreateHttpClient">
<CodeBlock language="csharp">
...
<TabItem value="something" label="CreateHttpClientSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="DisableAtomicDocumentWritesInClusterWideTransactionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="DisableTcpCompressionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="DisableTopologyCacheSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="DisableTopologyUpdatesSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="DisposeCertificateSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindClrType">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindClrTypeSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindClrTypeNameSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindClrTypeNameForDynamic">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindClrTypeNameForDynamicSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindCollectionName">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindCollectionNameSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindCollectionNameForDynamic">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindCollectionNameForDynamicSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindIdentityProperty">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindIdentityPropertySyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindIdentityPropertyNameFromCollectionName">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindIdentityPropertyNameFromCollectionNameSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindProjectedPropertyNameForIndexSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindPropertyNameForDynamicIndex">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FindPropertyNameForDynamicIndexSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FindPropertyNameForIndex">
<CodeBlock language="csharp">
{`// The default function:
...
<TabItem value="something" label="FindPropertyNameForIndexSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="FirstBroadcastAttemptTimeout">
<CodeBlock language="csharp">
{`FirstBroadcastAttemptTimeout = TimeSpan.FromSeconds(10)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="FirstBroadcastAttemptTimeoutSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="HttpClientType">
<CodeBlock language="csharp">
...
<TabItem value="something" label="HttpClientTypeSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="HttpVersionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="IdentityPartsSeparatorSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="MaxHttpCacheSize">
<CodeBlock language="csharp">
{`MaxHttpCacheSize = new Size(256, SizeUnit.Megabytes) // Set max cache size
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="disable_cache">
<CodeBlock language="csharp">
{`MaxHttpCacheSize = new Size(0, SizeUnit.Megabytes) // Disable caching
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="MaxHttpCacheSizeSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="MaxNumberOfRequestsPerSessionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="PropertyCasing">
<CodeBlock language="csharp">
...
<TabItem value="something" label="FirstChar">
<CodeBlock language="csharp">
{`private string FirstCharToLower(string str) => $"\{Char.ToLower(str[0])\}\{str.Substring(1)\}";
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="SerializationSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="OperationStatusFetchMode">
<CodeBlock language="csharp">
{`OperationStatusFetchMode = OperationStatusFetchMode.ChangesApi // ChangesApi | Polling
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="OperationStatusFetchModeSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="PreserveDocumentPropertiesNotFoundOnModelSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="RequestTimeout">
<CodeBlock language="csharp">
{`RequestTimeout = TimeSpan.FromSeconds(90)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="RequestTimeoutSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="ResolveTypeFromClrTypeName">
<CodeBlock language="csharp">
...
<TabItem value="something" label="ResolveTypeFromClrTypeNameSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="SaveEnumsAsIntegersSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="SecondBroadcastAttemptTimeout">
<CodeBlock language="csharp">
{`SecondBroadcastAttemptTimeout = TimeSpan.FromSeconds(20)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="SecondBroadcastAttemptTimeoutSyntax">
<CodeBlock language="csharp">
...
<TabItem value="something" label="SendApplicationIdentifierSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="TopologyCacheLocation">
<CodeBlock language="csharp">
{`TopologyCacheLocation = @"C:\\RavenDB\\TopologyCache"
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="TopologyCacheLocationSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="TransformTypeCollectionNameToDocumentIdPrefixSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="UseHttpCompressionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="UseHttpDecompressionSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="HttpCompressionAlgorithm">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="UseOptimisticConcurrencySyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="WaitForIndexesAfterSaveChangesTimeout">
<CodeBlock language="csharp">
{`WaitForIndexesAfterSaveChangesTimeout = TimeSpan.FromSeconds(10)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="WaitForIndexesAfterSaveChangesTimeoutSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="WaitForNonStaleResultsTimeout">
<CodeBlock language="csharp">
{`WaitForNonStaleResultsTimeout = TimeSpan.FromSeconds(10)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="WaitForNonStaleResultsTimeoutSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something" label="WaitForReplicationAfterSaveChangesTimeout">
<CodeBlock language="csharp">
{`WaitForReplicationAfterSaveChangesTimeout = TimeSpan.FromSeconds(10)
`}
</CodeBlock>
</TabItem>
<TabItem value="something" label="WaitForReplicationAfterSaveChangesTimeoutSyntax">
<CodeBlock language="csharp">
{`// Syntax:
...
<TabItem value="something-something" label="conventions_1">
...
<TabItem value="something-something" label="customFetchSyntax">
<CodeBlock language="nodejs">
{`// Returns an object
get customFetch();
...
<TabItem value="something-something" label="disableAtomicDocumentWritesInClusterWideTransactionSyntax">
<CodeBlock language="nodejs">
...
<TabItem value="something-something" label="disableTopologyUpdatesSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean value
...
<TabItem value="something-something" label="findCollectionNameSyntax">
<CodeBlock language="nodejs">
{`// Returns a method
...
<TabItem value="something-something" label="findJsTypeSyntax">
<CodeBlock language="nodejs">
{`// Returns a method
get findJsType();
// Set a method
...
<TabItem value="something-something" label="findJsTypeNameSyntax">
<CodeBlock language="nodejs">
{`// Returns a method
get findJsTypeName();
// Set a method
...
<TabItem value="something-something" label="firstBroadcastAttemptTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="identityPartsSeparatorSyntax">
<CodeBlock language="nodejs">
{`// Returns a string
...
<TabItem value="something-something" label="maxHttpCacheSizeSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="maxNumberOfRequestsPerSessionSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="requestTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
get requestTimeout();
// Set a number
...
<TabItem value="something-something" label="secondBroadcastAttemptTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="sendApplicationIdentifierSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
...
<TabItem value="something-something" label="storeDatesInUtcSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
get storeDatesInUtc();
// Set a boolean
...
<TabItem value="something-something" label="storeDatesWithTimezoneInfoSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
...
<TabItem value="something-something" label="syncJsonParseLimitSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="throwIfQueryPageSizeIsNotSetSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
...
<TabItem value="something-something" label="transformClassCollectionNameToDocumentIdPrefixSyntax">
<CodeBlock language="nodejs">
{`// Returns a method
...
<TabItem value="something-something" label="useCompressionSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
get useCompression();
// Set a boolean
...
<TabItem value="something-something" label="useJsonlStreamingSyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
...
<TabItem value="something-something" label="useOptimisticConcurrencySyntax">
<CodeBlock language="nodejs">
{`// Returns a boolean
...
<TabItem value="something-something" label="waitForIndexesAfterSaveChangesTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="waitForNonStaleResultsTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
...
<TabItem value="something-something" label="waitForReplicationAfterSaveChangesTimeoutSyntax">
<CodeBlock language="nodejs">
{`// Returns a number
