...
<Admonition type="info" title="LoadBalanceBehavior options " id="loadbalancebehavior-options" href="#loadbalancebehavior-options">
...
<Admonition type="info" title="Initialize LoadBalanceBehavior on the client " id="initialize-loadbalancebehavior-on-the-client" href="#initialize-loadbalancebehavior-on-the-client">
...
<TabItem value="something" label="LoadBalance_1">
...
<TabItem value="something" label="LoadBalance_6">
<CodeBlock language="csharp">
...
<TabItem value="something" label="LoadBalance_2">
<CodeBlock language="csharp">
...
<TabItem value="something" label="LoadBalance_3">
<CodeBlock language="csharp">
...
<Admonition type="info" title="Set LoadBalanceBehavior on the server " id="set-loadbalancebehavior-on-the-server" href="#set-loadbalancebehavior-on-the-server">
...
<Admonition type="info" title="When to use " id="when-to-use" href="#when-to-use">
...
<TabItem value="something-something" label="LoadBalance_1">
...
<TabItem value="something-something" label="LoadBalance_6">
<CodeBlock language="python">
{`# A customized method for getting a default context string
...
<TabItem value="something-something" label="LoadBalance_2">
<CodeBlock language="python">
{`# Open a session that will use the DEFAULT store values:
...
<TabItem value="something-something" label="LoadBalance_3">
<CodeBlock language="python">
{`# Open a session that will use a UNIQUE context string:
with document_store.open_session() as session:
