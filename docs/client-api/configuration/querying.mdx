...
<TabItem value="something" label="find_prop_name">
...
<TabItem value="something" label="find_projected_prop_name">
<CodeBlock language="csharp">
...
<TabItem value="something" label="users_index">
<CodeBlock language="csharp">
...
<TabItem value="something" label="find_projected_prop_usage">
<CodeBlock language="csharp">
{`Conventions =
\{
