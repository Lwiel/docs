...
<Admonition type="info" title="Scaling Up/Down - General" id="scaling-up-down-general" href="#scaling-up-down-general">
...
<Admonition type="info" title="Scaling - Change Instance Type" id="scaling-change-instance-type" href="#scaling-change-instance-type">
...
<Admonition type="info" title="Scaling - Change Storage" id="scaling-change-storage" href="#scaling-change-storage"> 
...
<Admonition type="info" title="Additional product nodes - General" id="additional-product-nodes-general" href="#additional-product-nodes-general">
...
<Admonition type="info" title="Additional product nodes - Adding a node to a database group" id="additional-product-nodes-adding-a-node-to-a-database-group" href="#additional-product-nodes-adding-a-node-to-a-database-group">
